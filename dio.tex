...
Osservazione: il caso $2$ e' superiore al caso $1$ perche' trovo che il resterare in pace con gli altri permette piu' facilmente di restare in pace anche con se stessi. Usando le notazioni di prima: se $\esAi$ e' in pace con $E$, anche se $E$ non ama $\esAi$, $\esAi$ sara' piu' facilmente in pace con se stesso, perche' la sua natura umana sociale ne trae beneficio. Secondo la fede Cristiana, essere caritatevoli anche verso il prossimo che non ci ama e' la via piu' breve per amare Dio.
...
La fede Cristiana e' il credere che scegliere l'amore e' sempre la via migliore, per il benessere dell'Anima.\\

Abbiamo detto che un essere e' Dio di se stesso e di chi lo ama. Come fa' una donna od un uomo ad essere Dio, anche se solo di se stesso ? Sembra strano, ma cio' che provoca la stranezza e' che in realta' ci domandiamo ``Come fa' una donna od un uomo ad essere Dio \emph{di me stesso} ?''. Cioe', non e' intuitivo guardare un altro essere dall'esterno senza volere il suo amore per noi stessi.

La domanda allora da porsi e' piuttosto: sono io Dio di me stesso e di chi mi ama? Ovvero, nella mia spontaneita' e nelle profondita' del mio cuore amo me stesso e chi mi ama ? Sono in pace con la natura, e nella realta' fisica conosco i limiti di essere un uomo (o donna), e mi impegno a stare bene e far stare bene chi mi ama con le mie forze e con le loro ? Sono in pace con la mia vita e ambisco alla pace nella vita di chi mi ama?

Se la risposta e' si, allora, da un punto di vista esistenziale, dal punto di vista dell'Anima, siamo Dio per noi stessi e per chi ci ama. Per dare supporto a questa tesi, consideriamo che 1. l'Anima e' infinita, come postulato all'inizio del capitolo. I nostri desideri, desideri della nostra Anima, sono infiniti in dimensione e potenzialmente in numero, ed essi sono tutti i desideri di ogni $a_j$ della nostra unione. I desideri forti, ovvero i bisogni, e i desideri non superflui, sono sacri. L'Anima desidera tutto il bene, e se raggiunto un certo livello di bene, desidera un livello maggiore. 2. Per soddisfare i desideri dell'unione, noi, come animo, consumiamo noi stessi e chi ci ama pure. Ogni consumo infinitesimo del corpo, e' una spesa infinitamente grande, dato che ogni nostra particella e' sacra (vedi poesia in pagina \pageref{bruciamoComeLegna}).

E' chiaro che come ``Io'' siamo esseri umani e limitati, pero' cio' che importa spiritualmente, per il nostro e altrui benessere spirituale, e' cio' che amiamo, cio' che siamo. Se siamo fonte di benessere per noi stessi e per chi ci ama, allora, innamorandoci di noi stessi, possiamo ritenerci Dio. 

Quindi, l'essere $\anima{A}_i$ nella sua totalita', non considerando solo il suo Io o una sua qualsiasi sottoparte o sottounione, e' Signore di se stesso e di chi lo ama, e gli esseri che ama sono Signori di lui stesso.
...
Infine, se consideriamo $N$ come un'essere con cui $a_i$ interagisce, allora come prima $a_i$ puo' 
...
Anche se e' necessaria un'interazione fisica, l'anima non automaticamente ama gli altri solo per il mero fatto che gli altri esistono, vivono fisicamente ``fuori'' dal suo se' e stanno bene perche' se la cavano da soli. L'anima ama quando interiorizzando gli altri, fa' diventare loro parti di se stessa e quando ama queste parti al pari di come ama il \emph{se'}.
...
Se l'essere $\anima{A}_{A_i}=A_1+A_2+\cdots$ e' pero' innamorato di un essere $A_j$, e quindi di un anima ``fuori'' dal suo se' ($A_j\ne A_i$), per l'animo di $A_i$ e' sufficiente amare l'anima di cui e' innamorato ($A_j$). Ricordiamo che $A_j$ rappresenta per $A_i$ l'intera anima $\anima{A}_{A_i}$, ovvero $A_j\simeq \anima{A}_{A_i}$.
Quindi, per l'animo $A_i$ e' sufficiente amare $A_j$ per amare tutta $\anima{A}_{A_i}$, incluso il se' $A_i$ e tutti gli altri esseri.
...
Definiamo l'\emph{Io} di un essere come quell'entita' che amministra l'energia dell'animo suo e la spende per dare piacere all'Anima, per proteggerla dal dolore e per guarirla.

L'Io essendo il prodotto di processi neurologici, e' limitato ed imperfetto. Tuttavia, l'Io mosso da Amore, \emph{tende} ad un punto fisso, un punto di equilibrio, di matura e piena realizzazione. Ogni anima ha bisogno e desidera costantemente che ogni Io lo raggiunga. Questo punto fisso e' \emph{Dio che si manifesta ed agisce sulla terra} e nel cattolicesimo e' chiamato \emph{Spirito Santo}.
...
Facendo tendere un Io all'infinito, possiamo adesso definire lo Spirito Santo, e cioe' Dio, come la \emph{chiusura di un qualsiasi Io che ama l'Anima}, ovvero, se $A$ e' qualcuno o qualcuna che ama l'Anima, allora Dio in $A$ e' quell'essere che rappresenta quanto piu' fedelmente $A$ e che, al contempo, riesce ad amare l'Anima completamente. Ad esempio, se pensiamo ad un panetterie che fa' onestamente il suo lavoro, la sua chiusura, il suo punto all'infinito e' un Panetterie, ovvero, un uomo che non solo fa' onestamente il suo lavoro ma che ama ogni suo cliente, che sa' a chi piace quale tipo di pane, e che se avesse tempo, parlerebbe con ciascuno e si preoccuperebbe dei loro problemi, e del poco tempo che ha lo spende per questo. E, non solo, Lui facendo il suo lavoro sta' bene e trova la gioia e la forza di vivere. E, infine, non vive solo per il suo lavoro, ma e' anche un uomo che ama la vita per quello che offre. 
...
Dire che l'Io tende a diventare Dio, non e' detto per caso. La tensione e' continua, ma mai finita, dato che un uomo non puo' essere pienamente divino. Nella dottrina Cattolica, solo Gesu' lo e' stato, ma di questo non ne so' abbastanza e non parlero'.
