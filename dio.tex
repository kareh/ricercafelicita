...
\def\esAE{\anima{A}_E}
    ...
    Abbiamo trattato l'Anima, come se fosse una entita' astratta, tuttavia, essa e' anche volonta'. E' l'essere che agisce, che tratta di se stesso e degli altri e della Natura, in maniera consapevole ad egli stesso od inconscia. Quindi, un'anima e' anche un \emph{Io}.

    L'Io \emph{ricerca} e \emph{genera} il bene per se' e il bene per gli altri che ama. A priori, le sue verita' ed i suoi comandi non sono valide ed utili. Solo se chi ama, sente il bisogno o desiderio di lui, il suo operato avra' efficacia. A volte, l'Io sfocia nella violenza leggera (instistenza verbale o comportamentale) o forte (fisica), questo avviene quando e' convinto che lui e' il bene per l'anima.

    $\esAi$ ricerca e stabilisce qual'e' il bene, ascoltando l'Anima e osservando cio' che procura piacere e cio' che procura dolore. Se apprezza la simpatia, tutti gli esseri che hanno una definizione uguale al suo se' di piacere e dolore saranno inclusi nell'unione $\esAi$ e amati da lui. Se e' caritatevole, anche tutti gli esseri che non sono uguali al suo se', ma rispettano, non contravvenendo la definizione del suo se', saranno pure inclusi nella sua Anima e amati. Se e' santo, anche gli esseri che non rispettano il suo se' o gli altri che ama, saranno amati da lui.
    ...
    Se $\esAi$ ama un altro essere, lo considera al pari di se stesso, e quindi, cosi' come lui ricerca e genera il bene, vedra' l'altro ricercatore e generatore di bene. Quindi, per ogni essere $a_j$ dell'unione $\esAi=a_1+a_2+\cdots$ si puo' scrivere:
\begin{align*}
