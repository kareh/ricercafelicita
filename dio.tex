...
\label{SullaFede}
Potremmo analizzare ogni aspetto della religione usando i due principi della materia morta e della santita', e tutto acquisirebbe senso razionale. Tuttavia, questo procedimento e' lento e macchinoso. Ostinarsi a vedere la vita in maniera scientifica, tramite una descrizione esteriore della realta', e' come parlare di uno sport di cui si e' affezionati ad un amico, ma usando formule fisiche con sistemi di equazioni con derivate parziali, che per quanto precise e capaci di simulare quello sport in un computer, non trasmetterebbero minimamente il senso della propria passione all'amico\footnote{e anche se l'amico giocasse alla simulazione virtuale di quello sport in un computer, non sarebbe la stessa cosa. Al pari di vedere un sentiero di montagna in Google Maps, piuttosto che in prima persona percorrere quel sentiero}.
