...
Consideriamo l'Anima $\A=a_1+a_2+\cdots+N+\cdots$, che include tutti gli esseri umani e la Natura. La volonta' di Dio, come Spirito (precedente paragrafo \ref{DioComeSpirito}), e' quella di soddisfare e realizzare i desideri e bisogni di $\A$ necessari o non superflui. $\A$ e' il fine dell'esistenza dello Spirito, quindi e' essa stessa divina, figlia o figlio amato di Dio. 
...
Un Io $a_i$, che ama tutta l'Anima, $a_i=\A$, e' esso stesso Dio, nei suoi limiti umani. Un esempio, e' Gesu'. Per indicare Gesu', usiamo la lettera $g$. Un qualsiasi altro Io che ama tutta l'Anima e' \emph{santo}. Poiche' i santi e Gesu' amano l'anima, si ha $g=s=\A$ per ogni santo $s$. Quindi, la loro anima e' una, e' tutta e solo l'Anima. Anche per questo, Gesu' vive ancora ogni qualvolta si manifesta un santo nel mondo.

Un santo $s$, e' un essere umano. Quindi, la sua anima, in verita', approssima $\A$, cioe' $s\simeq\A$. Nei suoi 7 peccati giornalieri, non riesce ad includere in se stesso completamente ed amare almeno un essere $a_i$. 
Tuttavia, la sua natura di essere umano che ricerca e sceglie il bene per se e per gli altri, fa' tendere se stesso all'anima $\A$, che e' il suo vero centro.

Un essere $d$ la cui anima e' esattamente $\A$ e' \emph{Dio Padre}. L'anima di un santo $s$, tende a diventare $\A$, quindi $s$ tende a diventare una piccola incarnazione e manifestazione di Dio in terra.
...
La differenza tra un essere $s$ che ama $\A$ ed un essere umano $a_i$ qualsiasi e' che il secondo oscilla tra il voler amare e non amare $\A$, mentre il primo, ha scelto di amare e solo amare e trova in cio' la sua identita' e pace.

Esplicitiamo che amare $\A$ vuol dire amare ogni essere $a_j$ vivente e non vivente, incluso l'ambiente naturale $N_j$ di ogni essere $a_j$. 
