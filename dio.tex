...
Cio' che accoglie, amministra e spende l'anima per realizzare il desiderio dell'animo e che valuta i risultati di tale desiderio, sia chiamato ``Io'' (o Noi se ci sono piu' Io che sono in unione tra loro).\\
...
Sia definito ``amore'' di un essere A verso un essere B quando l'anima di A e' empatica con B, quando l'animo di A desidera che A+B provi piacere e non dolore, e quando l'Io di $A$ spende saggiamente l'anima di $A$ per realizzare tale desiderio. Per la precisione, non si puo' parlare di A che ama B, ma piuttosto di A+B che ama B. 
