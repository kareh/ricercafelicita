...
Ricordandoci la definizione di spirito e desiderio (\ref{defDiDesideriDes} pag. \pageref{defDiDesideriDes}), definiamo lo Spirito Santo come lo spirito i cui desideri sono tutti e solo desideri santi.

In altre parole se $\spirit{a}$ e' l'insieme dei desideri, compresi quelli che non portano ad alcuna realizzazione per $a$, lo spirito santo $\saintspirit{a}$ e' l'insieme di tutti e solo i desideri che portano a realizzazioni vere per $a$.

$\saintspirit{\Dio}$ e' lo spirito di Dio: l'insieme di tutti i desideri che realizzano il bene per ogni uomo dell'umanita'.

Un uomo non potra' mai valutare obbiettivamente se un suo desiderio e' volonta' di Dio o no. Potra' procedere solo per fede. Tuttavia, quando si vedranno i risultati delle sue opere, si sapra' se era un desiderio ben posto o meno. Questo a volte sara' troppo tardi. Allora, e' importante l'allenamento spirituale come la preghiera per affinare la propria fede e amare propriamente Dio piuttosto che idoli.
