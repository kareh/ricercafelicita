...
La domanda allora da porsi e' piuttosto: amo veramente me stesso, amo veramente chi mi ama, e non solo nel pensiero ma nella mia spontaneita' e nelle profondita' del mio essere ? Sono in pace con la natura, e nella realta' fisica conosco i limiti di essere un uomo (o donna), e mi impegno a stare bene e far stare bene chi mi ama, con le mie forze ? Sono in pace con la mia vita e spendo la mia vita per la pace di chi mi ama ?

Se la risposta e' si, allora, da un punto di vista esistenziale, dal punto di vista dell'Anima, siamo Dio per noi stessi e per chi ci ama. Per non confondere noi stessi come Anima con il nostro Io, possiamo dire meglio: \emph{il nostro essere e' Dio per noi stessi e per chi ci ama}.

E declinando ulteriormente: \emph{l'essere di chi amiamo e' Dio per lui/lei stessa, per noi e per chi lo/la ama}.

Per chi non ci ama, il nostro essere non e' Dio (caso $2.$).\\

Ritornando alla religione, chi e' cristiano ama Gesu' e per lui Gesu' e' Dio. Per chi non lo ama pero', non e' cosi'.\\
