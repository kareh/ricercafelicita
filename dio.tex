...
Da questo, discende che Dio non e' presente al 100\% nella Terra negli esseri viventi. Tuttavia, l'esistenza di Dio e' concreta fino a quando esistera' almeno un Io che ama l'Anima, e che quindi e' per lei Dio in una percentuale positiva. L'Anima, si ricordera' cosi' della sua origine divina, e ritrovera' la forza, il coraggio e la gioia di vivere.
...
Possiamo riassumere tutto quanto detto cosi': 
\begin{enumerate}
    \item Dio esiste se almeno un Io, ovvero noi stessi, qualcun altro od altri, amano l'Anima.
    \item Nessun essere vivente od artificiale in Terra puo' incarnare completamente Dio.
    \item L'Anima si avvicina tanto piu' a Dio in Terra tanto piu' rimane appagata di cio' che riceve per carita' da chi la ama.
\end{enumerate}
