...
Un santo $s$, e' un essere umano. Quindi, la sua anima, in verita', approssima $\anima{U}$, cioe' $s\simeq\anima{U}$. Nei suoi 7 peccati giornalieri, non riesce ad amare completamente almeno un essere $a_i$. Tuttavia, la sua natura di essere umano che ricerca e sceglie il bene per se e per gli altri, fa' tendere se stesso all'anima $\anima{U}$, che e' il suo vero centro. (Nota dottrinale\footnote{
    Nella dottrina Cattolica, Gesu' e' proprio Dio, non approssima $\anima{U}$. Questo, in quanto egli ha amato completamente e perfettamente $\anima{U}$, senza mai peccare.
}). 
