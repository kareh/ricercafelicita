...
\subsection{Prima definizione di Dio}
    ...
    %%%%%%% TODO: qui di seguito da riscrivere. Veniva fatta una confusione tra Io e Se'. L'Anima e' il Se'. Ogni $a_i$ e' un se', con la s minuscola, ma non perche' e' meno importante del Se'. L'importanza del Se' e' pari al piu' piccolo dei se', ed il piu' piccolo ha importanza infinita per Dio. L'io e' cio' che muove il se', al fine di esaudire e soddisfare i suoi desideri e bisogni. L'Io e' l'unione degli io. E come prima, si puo' pensare Io_i = Io come portato avanti dalla componente io_i.
