...
Poi, con il progresso scientifico, sembra che le persone hanno avuto il coraggio di dire che cosi' le cose non andavano. Pero', si e' voluto buttare via tutto in nome della liberta' e catalogare ``Dio'' come appartente solo a menti primitive e prive di razionalita'. Cosi' facendo, in nome della verita' e della fine delle superstizioni, si e' creata un'altra superstizione: ``l'insensatezza dell'esistenza di Dio'', ovvero dire che e' insensato credere che la propria vita e' per se stessi e per gli altri, e che e' insensato credere che la vita non e' una lotta contro la Natura. E credere invece che la vita e' solo un fatto meccanico, di cui noi siamo padroni e di cui, nella nostra onnipotenza possiamo disporre arbitrariamente.\\
