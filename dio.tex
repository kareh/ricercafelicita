...
Un esempio di inclusione propria, in cui non vale l'uguaglianza, e' quando $A$ ama $B$ mentre $B$ non ama $A$, e si ha $\mathcal{A}=A+B+C+D$, mentre $\mathcal{B}=B+C$. $D$ ed $A$ stesso sono amati da $A$ ma non da $B$.\\
...
Se l'essere $\anima{A}_i=A_1+A_2+\cdots$ e' pero' innamorato in maniera sana di un essere $A_j$, con anima $\anima{A}_j$, e quindi di un anima apparentemente fuori dal suo se' ($A_j\ne A_i$), per l'animo $A_i$ e' sufficiente amare solo l'anima di cui e' innamorato ($A_j$). Infatti, se l'anima $\anima{A}_j$ ama cio' che $\anima{A}_i$, allora $A_i$ amando $\anima{A}_j$ sta' amando $\anima{A}_i$.
...
Abbiamo detto che un essere e' Dio di se stesso e di chi lo ama e lui ama. Come fa' una donna od un uomo ad essere Dio, anche se solo di se stesso ?  Sembra strano, ma cio' che provoca la stranezza e' che in realta' ci domandiamo ``Come fa' una donna od un uomo ad essere Dio \emph{di me stesso} ?''. Cioe', non e' intuitivo guardare un altro essere dall'esterno senza volere il suo amore per noi stessi. In secondo luogo, in questa definizione abbiamo attenzionato l'essere come Anima, e non come Io. Questa differenza e' molto difficile da afferare, e va' maturata col tempo. In altre parole, se l'essere $A_i$ ama almeno un altro essere $A_j$, allora \emph{lui non e' piu' solo $A_i$, il suo Io, ma e' anche l'altro essere $A_j$}. Poeticamente, si potrebbe dire che in lui vive anche $A_j$, che e' una sua parte. Questo concetto l'abbiamo affermato piu' volte nel capitolo.

La domanda allora da porsi e' piuttosto: amo veramente me stesso, amo veramente chi mi ama e io amo, e non solo nel pensiero ma nella mia spontaneita' e nelle profondita' del mio essere ? Sono in pace con la natura, e nella realta' fisica conosco i limiti di essere un uomo (o donna), e mi impegno a stare bene e far stare bene chi mi ama, con le mie forze ? Sono in pace con la mia vita e spendo la mia vita per la pace di chi amo ?

Se la risposta e' si, allora, da un punto di vista esistenziale, dal punto di vista dell'Anima, siamo Dio per noi stessi e per chi ci ama e amiamo. Per non confondere noi stessi come Anima con il nostro Io, possiamo dire meglio: \emph{il nostro essere e' Dio per noi stessi e per chi ci ama e amiamo}.

%TODO: scrivo sempre per chi ci ama e amiamo, ma nel caso 2 avevo ragionato che e' sufficiente dire 'per chi amiamo'

E declinando ulteriormente: \emph{l'essere di chi amiamo e ci ama e' Dio per lui/lei stessa e per chi lo/la ama e lui/lei ama}.

Per chi non ci ama, il nostro essere non e' Dio (caso $2.$).
...
Nota: stiamo anche parlando di Anima e non di anima. Nell'accezione tradizionale ``anima'' riguarda l'Io di una persona, e' la sua intimita' personale. Qui con Anima $\anima{A}_i$ indichiamo l'unione di tutte le anime $a_1+a_2+\cdots$ che l'essere $a_i$ ama. Quindi, bisogna fare attenzione, perche' il discorso di sopra non e' un discorso ego-istico, centrato sull'ego di $a_i$, e' un discorso di unita'.


Piu' in seguito definiremo Dio partendo dal basso, ovvero dalle cose finite, quando parleremo dell'Io.
