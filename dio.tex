...
Che un Io possa essere considerato da chi lo ama (da se stesso o da altri) come onnipotente, non e' una sorpresa. Infatti, la mente crea la realta' (vedi appendice \ref{menteCrea} pag. \ref{menteCrea}). Noi esperiamo una realta' che noi stessi creiamo. Tuttavia, la vera onnipotenza e' quella crea una realta' di pace e gioia per l'anima propria e altrui. Solo un Io che crea la vita in se e negli altri, tramite e solo tramite l'amore disinteressato, al pari di come ha fatto Gesu', puo' essere definito come Dio e chiamato ``santo''. L'Io santo primogenito e' quello di Gesu'.
...
Per quanto riguarda un Io non santo, Dio puo' essere presente in misura maggiore o minore in se, a seconda di quanto l'Io e' conforme a l'Io di Cristo. A volte lo sara' di piu' in alcuni momenti e situazioni, a volte di meno in altri.
Dio e' cosi', per la maggioranza di noi, in parte nei ``cieli'', in parte in ``terra''. Un Io di un uomo puo' allora ricercare la sua completa unione con Dio, puo' cercare di conformarsi pienamente all'Io di Cristo. 

Dio come Padre, Dio come Io, Dio come Spirito Santo, coincidono in Gesu'. In un uomo, invece, Dio come Padre e' il limite all'infinito a cui sta' tendendo l'Io nella sua ricerca e tensione verso la santita'. Lo Spirito Santo e' l'Io con i suoi talenti che gia' concretizzano in se alcuni aspetti di Dio. 

Gesu', e' esistito storicamente e chi si incammina nel cammimno della pace e dell'amore disinteressato, non puo' che riconoscere in lui la realizzazione totale di tale amore, e riconoscerlo cosi' come figlio di Dio.
...
Il Padre, come entita' trascendente, esiste. Infatti, una persona ha dei bisogni e dei ``desideri necessari'', e quindi e' per lei possibile ambire a conoscere quell'essere $x$ che puo' soddisfare tali bisogni e desideri. Questo essere divino $x$, inizialmente potrebbe essere approssimato da lei stessa, ma conoscendosi, questa persona capira' che puo' migliorare nell'amarsi. Quindi, per lei puo' esistere una versione migliore di se stessa. Allo stesso modo, se la persona si innamore di un'altra, e approssima $x$ con l'altra persona, poi, molto probabilmente, capira' che l'altra persona sara' limitata in qualcosa, e vorra' che l'altra persona migliori. Se $x_0$ e' la prima approssimazione a cui si rivolge la persona per vivere in pace e gioia, il Padre e' $x_{\infty}$, e' cio' a cui, chi ama la persona, tende per amarla al meglio. Essendo $x_{\infty}$ ben definito, si puo' considerare come esistente concretamente, quasi esistente in carne e ossa in terra, e si puo' dire che il Padre ama piu' di quanto e meglio di come la persona puo' a causa dei suoi limiti, limiti che puo' superare nella ricerca della santita'.
