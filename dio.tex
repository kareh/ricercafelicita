...
Dal paragrafo \ref{amareSe} pag. \pageref{amareSe}, si discute in maniera piu' semplice su cosa consiste avere fede in Dio. Si arrivera' a una definizione di Dio che fa leva sul discorso sviluppato in  \ref{DioPadreOnnipotenteDef} pag. \ref{DioPadreOnnipotenteDef} e in \ref{DioScientificamentePoesia} pag. \ref{DioScientificamentePoesia}.
...
Dio, come Padre onnipotente e creatore, e' l'essere umano in unione con l'umanita' intera e con la natura, che pienamente e totalmente santo, non piega la natura cercando di renderla cio' che non e', ma piuttosto, da' vera pace e gioia a chi a bisogno, in ogni condizione il suo corpo e la sua psiche si trovino. Fa questo in maniera terrena, adoperando forze ed energe fisiche tramite lo Spirito Santo, e per il resto, in maniera celeste, tramite forze ed energie spirituali. E' un essere che non si puo' comprendere con l'usuale logica della realta' quotidiana. E' veramente onnipotente, ma non si puo' comprendere questo con l'usuale intuizione, anche se non contraddice alcuna legge fisica, ne' ne introduce altre. Il Padre accetta i limiti, l'umilta', le difficolta', la mortalita' di un essere umano, e nell'accettare tutto cio' che l'egoismo e il narcisismo non puo' accettare, da' pace a se stesso e agli altri, anche nelle condizioni piu' serie, gravi e critiche. Questo, un uomo con neanche tutta l'energia dell'Universo potrebbe farlo.
