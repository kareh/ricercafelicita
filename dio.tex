...
Fin'ora abbiamo detto che un'anima $a_i$ ama o non ama un essere $a_j$, e se lo ama, $a_j$ e' incluso in se, ovvero $a_i=\cdots+a_j+\cdots$. Adesso, introduciamo un concetto di perfezione divina e di imperfezione umana: $a_i$ ama, come essere umano, $a_jk_{ij}$ e non $a_j$ (nota tecnica\footnote{$a_jk_{ij}$ si puo' intendere insiemisticamente come l'intersezione tra $a_j$ e $k_{ij}$ e' il cuore di $a_i$ per $a_j$. Nel limite della perfezione di $a_j$, $k_{ij}$ e' uguale ad $a_j$ e quindi $a_jk_{ij}=a_j$}). $a_jk_{ij}$ e' una versione ridotta di $a_j$, a voler intendere che $a_i$ non riesce ad amare completamente il vero $a_j$. Al limite infinito della perfezione di $a_i$, $a_jk_{ij}$ tende ad $a_j$ e $a_i$ ama completamente $a_j$.

Un Io $a_i$, che ama tutta e completamente l'Anima, $a_i=\anima{U}$, e' esso stesso Dio, nei suoi limiti umani. E' \emph{Dio Figlio}, e' Dio, che incarnato in un essere umano, e' sia uomo sia Dio. Un esempio, e' Gesu'. Per indicare Gesu', usiamo la lettera $g$. Un qualsiasi altro Io che ama tutta l'Anima e' \emph{santo}. Poiche' i santi e Gesu' amano l'anima, si ha $g=s=\anima{U}$ per ogni santo $s$. Quindi, la loro anima e' una, e' tutta e solo l'Anima. Anche per questo, Gesu' vive ancora ogni qualvolta si manifesta un santo nel mondo, e vive 
