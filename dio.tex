...
La realizzazione dell'essere umano nell'Amore e' un'incarnazione di Dio. Ma tale realizzazione non si puo' pensare in termini normali e mondani.
Seppur realizzato, un figlio di Dio non e' un super-uomo, per come immaginiamo che sia l'onnipotenza dei super-eroi. Se realizzato, Lui e il Padre sono pero' una cosa sola, e cio' che e' stabilito dal Padre, e' accettato dal figlio, e cio' che e' richiesto dal figlio, e' ascoltato dal Padre\footnote{``Io sono nel Padre e il Padre e' in me'' Nuovo testamento, Giovanni, capitolo 14, versetto 11}.
Cosi', tutto si muove secondo la Sua volonta', che e' quella del Padre, e quella del figlio, unica volonta'.
\\
Realizzato nell'amore? Quale amore?  Come descriverlo?
Astrattamente, matematicamente, poeticamente?
Impossibile! Sarebbero parole troppo ambigue, che troppo facilmente prospetterebbero miele, pur essendo scritte con mani sporche.
Ma un uomo, il primo totalmente realizzato nell'amore, con la sua vita ha scritto nella storia, la definizione perfetta: ``Dio e' Gesu' ''.
...
la gioia e serenita' a tutti coloro che lo hanno ascoltato.
...
Lo stesso vale per l'Io altrui, divenuto Gesu', e noi chiamati ad amarlo.
\\
...
Ritornando in ottica positiva, sono le nostre vite che hanno valore, e se noi viviamo per amarle, diventiamo divini. Ed anche parlare e pregare con una semplice figura, un'immagine prodotta dalla mente propria ed altrui, a cui attribuiamo valori trascendenti ed onnipotenti, acquista valore divino e sacro se questo nutre l'anima nostra e l'anima di chi ci e' accanto. Se noi amiamo, i nostri processi elettrochimici, diventano divini, perche' ridanno vita a noi ed agli altri che hanno bisogno di noi. E i processi elettrochimici degli altri hanno importanza per noi: Dio e' \emph{ognuno} che ama, ed esclusivamente ama\footnote{cioe' e' Santo. Che per unita', e' uno con Cristo.}.
