...
Non per forza bisogna sacrificare la propria vita per difendere e cambiare un'istituzione, ad esempio, studiando con l'ambizione di diventare direttore dell'istituzione, col rischio comunque di non diventarlo, per poi difenderla e tentare di cambiarla. Pero', scendere in campo per cio' che si crede, anche in una parte piccolissima e' molto piu' valido di lamentele scadute da tempo, di fughe da regole e leggi di cui riconosciamo il valore ma che non riusciamo ad applicare, e di promesse senza assunzioni di responsabilita'.
