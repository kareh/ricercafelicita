...
Pensiamo a ``Dio'' come ad un concetto primitivo e naturale, non definibile tramite altri concetti e di cui il suo significato di base e' intuibile da qualunque essere umano.\footnote{In matematica, gli ``insiemi'' sono concetti primitivi. Quando si fa' matematica, si presuppone che sia chi parla che chi ascolta sappiano cosa si intende per insieme (ovvero, un contenitore di ``elementi'')}.\\

Per dare l'idea: ``Dio'' e' colui che ama te stesso, ovvero cio' che e' dentro di te, e che ama ogni altro ed ogni particella della Natura, ovvero cio' che e' fuori da te. E' colui che tramite le forze tue e degli altri, procura il piacere in te e in loro, ed allontana il dolore, senza venire meno alle leggi dell'Universo che ha eternamente promesso alla Natura. Qualunque proprieta' positiva e che conduce alla Vita, e' Sua: saggezza, grazia, verita', grandezza, bellezza.

Per chi lo ama, non esistono forze e fenomeni che non rispettino o accadino secondo la Sua volonta', ogni cosa esistente e' manifestazione della Sua volonta'. Per chi lo ama, nulla lo turba e inquieta. Ogni cosa della Natura e', semplicemente od intelligentemente, una risorsa. Chi lo ama, per amare chi ha bisogno di Lui mette in moto e consuma ogni parte del suo essere.

Nel rigore logico, non stiamo indicando alcuna entita' esistente od immaginaria come Dio. Stiamo solo dicendo che qualunque entita' rispetti la definizione data di Dio, e' Dio. 

Dove e in che entita', interiore od esteriore, si possa trovare Dio, e' una questione interessante, ma e' proprio il punto della Ricerca. Questa questione e' stata trattata nei paragrafi precedenti. Non e' pero' oggetto di questo paragrafo, che vuole dare definizioni, termini e formule per riuscire a trattare logicamente la questione.
...
Anche amando l'anima dell'innamorato, l'animo sta' sempre amando la sua anima. Infatti, potrebbe mai essere innamorato di un'anima che e' l'esatto opposto della sua? Se la ama e' perche' rappresenta la sua, in ottima (o perfetta) approssimazione. Nota: esatto opposto qui e' inteso non in termini poetici, ma in termini logici: un essere che ama non procurare dolore al prossimo, non sara' innamorato di uno che invece ama cio'.
...
Definiamo \emph{Io} di un essere come quell'entita' che amministra l'energia del suo animo e la spende per dare piacere all'Anima, e per guarirla e proteggerla dal dolore.

L'Io essendo il prodotto di processi neurologici, e' limitato ed imperfetto. Tuttavia, l'Io mosso da Amore, tende ad un punto fisso, un punto di equilibrio, di massima realizzazione. Ogni anima ha bisogno e desidera costantemente che l'Io lo raggiunga. Questo punto fisso e' Dio.

Che l'Io diventi Dio, non vuol dire che diventa potente e perfetto, al di sopra della natura, e che non ha bisogno piu' di nessun altro, che e' al di sopra delle leggi, e che puo' fare cio' che vuole di ogni vita. 

Vuol dire che e' speso ed indirizzato verso tutti i bisogni ed i desideri non superflui dell'Anima nella sua completezza e nell'individualita' di ogni sua parte, ovvero dell'anima di ogni essere che la compone\footnote{logicamente, questo se l'anima del se' e' empatica, che e' cosi' naturalmente per gli esseri umani}. Ogni sua azione e pensiero, respiro ed intenzione, e' volto a creare la vita in ogni essere, a mantenerla ed esaltarla.

Gesu' e' Dio non perche' e' stato privilegiato o perche' aveva i super poteri, ma perche' ha dato modo ad ogni essere umano di smettere di essere legato ad una cultura oppressiva, a vizi e deviazioni psicologiche e di rimettersi in cammino nel proprio percorso di realizzazione. Anche per questo, credo che la chiesa Cristiana, riconosce Gesu' e solo Gesu' come l'unico essere umano che e' diventato ed e' Dio: ognuno e' volto a diventare Dio, ma nessuno piu' puo' sedurre gli altri verso cammini diversi da quello tracciato da Gesu', che fondamentalmente e' l'amore disinteressato ed universale verso tutti.

Anche se fisicamente un Io realizzato non puo' trasformare il piombo in oro, puo' pero' trasformare la vita di se stesso, e la vita degli altri, in misura minore o maggiore. Se l'Io si sara' speso veramente per trasformare il piombo della vita in oro, allora cio' varra' veramente molto, che venga riconosciuto o meno dagli altri o addirittura da chi viene amato.

I segni di una tale realizzazione e trasformazione sono la vera conoscenza, che va' oltre l'informazione della scienza, sono l'essere in unita' con Dio, e cioe' con la Natura, gli uomini e le donne, i bambini e gli anziani ed ogni altro essere che Lui ama, e seppur nelle difficolta' e tensioni della vita, vivere e far vivere attimi che vengono chiamati ``gioia'', ``felicita' '', ``pace''. Seppur, brevi, sono momenti genuini che durano per sempre: guardando indietro mai si provera' pentimento o tristezza per quei momenti, e guardando bene, si vedra' che avranno dato spunto per l'avvenire di altri eventi costruttivi nella vita.

Quindi, definiamo \emph{Dio} come quell'entita' che soddisfa pienamente i bisogni e i desideri non superflui dell'Anima, ovvero dell'unione di ogni anima. 

Anche se nessuno in terra e' volto a soddisfarli, fino a quando un'anima non si cedera' alla morte, e manterra' vivi i bisogni e i desideri necessari dell'Anima, allora, Dio esistera'. Perche' l'Io di quell'anima stara' amando l'Anima, seppur solo nel desiderio.

Se l'Io di quell'anima impieghera' sue risorse e capacita', allora l'Anima sara' amata non solo nel desiderio. Quindi, la qualita' del suo amore sara' piu' piacevole. Non c'e' pero' qualita' peggiore o migliore. Se l'essere non sta' sottraendo nulla di se' nel suo amore, allora il suo amore e' gia' ottimo, anche se piu' difficile da riconoscere come tale.

Quindi, Dio si trova in ogni Io (persona) che ama l'Anima. Non si trova nelle persone che amano meglio degli altri, perche' un tale concetto di migliore e' assurdo.

Per chi ama tramite la bravura, e' vero che la vera bravura consiste in un indirizzamento ed una spesa dei desideri e delle energie proprie (ed intime) di ogni animo che ci ama.

Infine, tanto piu' ogni essere umano si avvicina a Dio, tanto piu' esponenzialmente l'Anima ne trae benefici. Gesu', i Santi e molti grandi uomini nella storia ne sono la prova.

Anche se la visione di Dio, come punto fisso e di massima realizzazione dell'Io proprio e dell'Io degli altri e' inizialmente distante dalla visione religiosa cattolica, e' comunque la stessa. Il punto di unione e' lo Spirito Santo: la presenza di Dio in terra e' una necessita' di ogni anima, percio' la realizzazione concreta di Dio nella terra e' fondamentale, soprattutto ai giorni nostri, e non e' da pensare come un limite irraggiungibile, da lasciare a vite prossime o solo ad anime elette. Lo Spirito Santo, nella dottrina Cattolica, e' il ponte tra Dio ultra-terreno e Dio che opera in terra.

%TODO: continue
%TODO: continue

Questo punto fisso e' infinito, dato che e' il risultato di una continua tensione, cambiamento e rinnovamento dell'anima verso esso. Inizialmente, e' difficile da raggiungere, e' instabile: una volta raggiunto, si ricomincia da capo. Tuttavia, e' questo lo scopo dell'anima, raggiungerlo e mantenerlo, quanto piu' completamente e stabilmente. E se perso, ritrovarlo. Quindi, 
