...
\subsection{Prima definizione di Dio}
   ...
   Se un Io lamenta che Dio non esiste, dovrebbe esaminare se stesso e vedere quanto puo' essere migliore, piuttosto che desiderare che qualcuno o qualche entita', fuori da lui, risolva i suoi problemi, oppure prendersela con gli altri con la scusa che non lo amano o non lo amano abbastanza.
    ...
    Amare l'Anima non e' una questione di quantita' oggettiva, ne' di risultati oggettivi. E', piuttosto, se l'Io \emph{esiste} per l'anima amata. Che poi consumi poco o molto del suo essere, non importa. Questo perche' e' il consumo del \emph{suo} essere, ed e' un suo dono! Il vero problema e' che a volte l'Io crede o dice di stare amando un'anima, quando invece, non e' cosi'. Nel nostro linguaggio, l'essere $\esAi=\anima{A}_1+\anima{A}_2+\cdots$ dice di stare amando $\esAj$, quando invece, $\esAj$ non e' incluso nell'unione $\esAi$. Viceversa, $\esAj$ potrebbe essere incluso e $\esAi$ potrebbe anche non dare o fare niente di utile per $\esAj$, e in questo caso $\esAi$ starebbe comunque amando $\esAj$. Certo che, se e' vero questo secondo caso, se $A_i$ \emph{puo'} fare qualcosa di benefico per $A_j$, $A_i$ lo fara'. Pero', dall'esterno non si puo' giudicare se $A_i$ puo' o meno fare qualcosa per $A_j$, non si puo' giudicare se $A_i$ \emph{si sente di poter fare} qualcosa per $A_j$. In termini religiosi, solo quando lo Spirito muovera' $A_i$, $A_i$ potra' fare qualcosa per $A_j$.\\

   Definiamo la \emph{preghiera} come una libera condizione che l'Io lascia ad un anima, in cui lei puo' fare chiarezza per se stessa ed esprimere, con speranza e fiducia, i suoi bisogni e desideri. La preghiera e' quello stato in cui l'anima parla a Dio che e' in un Io (od in un Noi), anche se questo essere di Dio in un Io e' solo in forma primordiale. E' l'Io che, libero di ascoltare o non ascoltare la preghiera, di attivarsi o meno, quando si attiva e sceglie di spendersi, diventa uno con Dio, Sua manifestazione ed azione, e si spende per i bisogni e desideri dell'anima.
