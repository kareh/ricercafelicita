...
Un'anima $d$, che ama perfettamente tutta l'Anima $\anima{U}$, e' Dio, come anima (non come Spirito), e vale $d=a_1+a_2+\cdots+N+\cdots=\anima{U}$. Tale anima non esiste in terra, non puo' esistere fisicamente, ne' in alcun modo sensibile per un essere umano. Tuttavia tale anima, e' il limite all'infinito di ogni anima $a_i$ che tende ad amare $\anima{U}$. Questo limite, anche se non fisico, esiste perche' rappresenta la realizzazione piu' vera, piena e naturale di ogni $a_i$. Nella realta', $a_i$ non potra' amare perfettamente con la sua mente, corpo e psiche tutta l'anima $\anima{U}$. Se pero' $a_i$ raggiunge il suo limite naturale, $\overline{a_i}$, allora e' cosi' pure Dio, incarcanato in Terra, come uomo. Allora, $d$ e' \emph{Dio Padre della Trinita'}, mentre $\overline{a_i}$ e' un $\emph{Santo}$. Gesu' $g$, e' il santo dei santi, ed e' $\emph{Dio Figlio} della Trinita'. 
