...
Gesu' e' un essere umano la cui anima e' stata pienamente $\anima{U}$, ovvero $g=\anima{U}$. Poiche' $\anima{U}$ comprende tutti gli esseri viventi presenti, passati e futuri, in ogni luogo dello spazio, $\anima{U}$ esiste, e' esistita ed esistera' sempre, e quindi anche Gesu'. In altre parole, Gesu' ha amato ognuno di noi, e proprio per questo non e' morto. E' come un padre che continua a vivere nei figli, anche se ognuno di loro e' un'altra persona da lui. Avendo il padre amato i suoi figli, loro erano una parte della sua anima, e quindi, con loro, continua a vivere. E' anche vero che possiamo vedere l'immagine di Gesu' in ogni persona che ama $\anima{U}$, e questo, tanto piu' una persona ama se stessa e gli altri, come lui ha amato tutti. Ad esempio, nella lotta non violenta di Gandhi contro il potere, si rivede l'ascesa non violenta allo stato di re dei credenti di Gesu'.
