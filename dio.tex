...
\def\esAi{\anima{A}_{A_i}}
\def\esAE{\anima{A}_{E}}

    Abbiamo trattato l'Anima, come se fosse una entita' indipendente che agisce, tuttavia, essa e' un'aspetto dello stesso essere. E' l'essere che agisce, che parla di se stesso e degli altri e della Natura, in maniera consapevole ad egli stesso od inconscia. Quindi, $\esAi=A_1+A_2+\cdots+N$ e' l'essere in se', nella sua totalita'!, e non solo nel suo Io.
...
\begin{defn}
    ...
    Dopo aver parlato solo dell'essere $\esAi$, sussiste un fatto molto importante: ogni essere esistente e' Dio di se stesso, e se $\esAi$ lo ama, lo considera in quanto tale. Quindi, si puo' scrivere: $\anima{A}_{A_i} \supseteq \anima{A}_{A_j}$ per ogni $A_j$ di $\anima{A}_{A_i}$. Intendendo che l'essere e unione $\esAi$ comprende ogni essere ed unione $\anima{A}_{A_j}$ per ogni essere $A_j$ amato di $\esAi$ (e cio' vale ricorsivamente). 

    Ma anche un qualsiasi essere $E$ non dell'unione $\esAi$ e' Dio di se stesso. Cosa succede allora? Ci sono tre casi:
    ...
    \begin{enumerate}
        ...
        \item    Se entrambi si amano, allora la loro anima sara' uguale e i lori animi concordi, ognuno vedra' pure nell'altro Dio, e Dio sara' uno solo. 
                ...
                In formula: $\anima{A}_{A_i} = \anima{A}_{A_j}$ per ogni $A_j$ di $\anima{A}_{A_i}$.
...
La scelta va' fatta da $A_i$ tenendo presente quale delle due opzioni dara' maggiormente nutrimento ed appagamento all'Anima $\anima{A}_{A_i}$. 
...
Nota: stiamo anche parlando di Anima e non di anima. Nell'accezione tradizionale ``anima'' riguarda l'Io di una persona, e' la sua intimita' personale. Qui con Anima $\anima{A}_{A_i}$ indichiamo l'unione di tutte le anime $A_1+A_2+\cdots$ che l'essere $A_i$ ama. Quindi, bisogna fare attenzione, perche' il discorso di sopra non e' un discorso ego-istico, centrato sull'ego di $A_i$, e' un discorso di unita'.
