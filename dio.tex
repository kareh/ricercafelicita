...
Abbiamo detto che un Io mosso dal suo animo e' per un anima Dio in una certa percentuale. Un Io, od un Noi, non potra' mai essere al 100\% Dio per un'anima. Questo perche' vorrebbe dire che per la sola esistenza di questo Io, l'Anima non patirebbe mai sofferenze, difficolta' e smarrimenti nella sua vita in terra. 
