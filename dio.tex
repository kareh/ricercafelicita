...
\end{align*}
   intendendo che l'unione $\esAj$ e' compresa ed e' propria dell'unione $\esAi$. Nello specifico se $a_k$ e' parte dell'unione $\anima{A}_j$, allora sara' parte dell'unione $\anima{A}_i$. Cio' vale senza fine (ricorsivamente): se $a_{m}$ e' parte di $\anima{A}_k$, sara' anche parte di $\anima{A}_i$ e cosi' via.
