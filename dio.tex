...
\eal{& \lim_{v(a_i)\to \infty} a_i = d }
dove $v(a_i)$ sono le virtu' di $a_i$. Cosi', Dio e' il limite di un'anima con tutte le sue virtu' portate all'infinito.

Per portare le virtu' all'infinito, bisogna in qualche modo procedere. La via dell'amore e della carita' e' la via di FGesu'. Inoltre, un'anima raggiunge tale limite piu' velocemente se cammina insieme ad altre anime che ricercano lo stesso limite. Questo e' il senso della comunita' religiosa. Non siamo delle isole, ed il confronto, la sana competizione, i piccoli incitamenti, rimproveri, lodi, sono preziose. Infine, un'anima, raggiunto tale limite, rimarrebbe incompleta se anche le altre anime che ama e che la amano, non lo raggiungessero. Questo e' il senso della carita'.
