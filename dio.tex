...
Spendiamo qualche parola in piu' sulla concretezza effettiva di Dio. Se abbiamo un bisogno e ci viene chiesto ``di cosa hai bisogno?'' noi sappiamo quasi sempre rispondere, ed anche quando non ne siamo in grado, siamo consapevoli che quello di cui abbiamo bisogno non ce lo abbiamo ma, in qualche modo c'e' da qualche parte, e ci serve. 
Quindi, in ogni caso, abbiamo dentro di noi una qualche cognizione del cosa abbiamo bisogno. Se non ci scoraggiamo, non ci domandiamo mai ``quello di cui ho bisogno esiste?'', perche' quanto meno ci mettiamo alla ricerca sua. Quindi, anche se non abbiamo una soluzione ai problemi nostri e degli altri, alle necessita' o ad i desideri, se li riteniamo importanti e ci mettiamo in moto per essi, siamo sempre convinti che esistera' una qualche cosa che li risolve, a meno che non ci siamo arresi o siamo depressi.

Ritornando alla definizione di questa sezione, cosi' come se abbiamo un bisogno esiste, in qualche forma interiore, cio' che e' soluzione, che poi si concretizzi nella realta' rispettando le aspettative in misura piu' o meno fedele, allora esiste, in qualche forma interiore, cio' che e' Soluzione al desiderio $\des{\anima{A}}$ dell'Anima, ovvero esiste Dio, se non ci arrendiamo al fatto che ancora non la abbiamo concretamente tra le mani, e se avvaloriamo cio' che e' gia' parzialmente soluzione ma a cui non facciamo caso.
