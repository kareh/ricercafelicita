...
Il Se' e' come un legno che e' stato tagliato e che e' pronto per essere modellato e mantenere una forma. Si potra' dire ``che sia un tavolo'' o ``che sia una sedia'', a seconda di quello che serve.  Inizialmente l'Anima di un essere umano non sa' che forma dare al proprio Se', l'essere non ha ancora una identita'. Ma quando dice ``mi voglio bene'', assumera' l'identita' di una persona ed anima che ama se stessa, in formula $a_i=a_i+\cdots$, e quando dice ``ho bisogno di cibo'', assumera' l'identita' di una persona che cerca del cibo per se stessa, quando dice amo quelle altre anime, assumera' l'identita' di un'anima empatica che ama altre anime, in formula $a_i=a_i+a_1+a_2+\cdots$. Tuttavia, tra le varie possibilita' di esistenza, una sola e' quella migliore, e questa e' quella che piu' incarna \emph{Dio} tramite il proprio Se'. Quando l'anima e' \emph{veramente Se stessa}, si dice, allora l'anima sara' al meglio delle sue potenzialita', al massimo del piacere egoistico ed altruistico, al minimo della generazione di dolore proprio ed altrui. L'Anima non sa' inizialmente chi e' Dio, come e' meglio adoperare il se', se si trovera' meglio amando poco o molto, faticando poco o molto e in che modalita', e puo' scegliere verso quale possibilita' di esistenza indirizzarsi solo tramite la fede, tramite il credere. Non c'e' nessuno ne' niente, neanche lei stessa, che puo' stabilire a tavolino chi lei e' veramente. Quindi, l'unico modo e' il suo credere, ovvere il fare con umilta' cio' che crede sia meglio fare, l'amare ``ciecamente'' la persona di cui e' innamorata, l'applicare seriamente e costantemente cio' che crede di aver capito tramite lo studio e il dialogo, il provare con coraggio nuove direzioni, e il pentirsi di essere stata cio' che riconosce lei non e'.

Abbiamo definito il Se' tramite una definizione gia' assunta data di Dio. Viceversa, possiamo definire Dio, come l'origine e fonte di vita di ogni Se' e di ogni particella della Natura. Ogni Se' e cosa esistente, ha una proprieta' divina che e' appunto la sua esistenza. Per quanto un frutto di un albero possa essere amaro o brutto, esso esiste, cosi' come e', e per quanto un essere vivente sia fastidioso o pericoloso, egli esiste e desidera essere cio' che e'. Allo stesso modo noi stessi. Per quanto ci amiamo poco o molto, esistiamo e viviamo, e questo e' miracoloso e grande. Quindi, il Se', per questa proprieta', e', oso dire, Dio stesso, ed e' figlio di Dio Padre. Gesu' ha gia' dimostrato al mondo, che anche il piu' umile di questa terra e' amato dal Signore ed e' suo figlio, ed anche i peccatori lo sono. Noi siamo figli di Dio, siamo Dio noi stessi, per quanto il nostro cuore con il peccato ci deturpi e deformi e ci allontana dalla nostra vera forma e vita. 
Il Se', il vero Se', e' allora Dio. Noi, nascendo inesperti ed bambini, non lo conosciamo, e solo i saggi lo conoscono fino in fondo, e solo i santi lo amano completamente. Abbiamo sempre la necessita' di amarlo, di ascoltarlo, di conoscerlo piu' a fondo, ed allo stesso modo il Se' altrui.  Questo amore, deve andare al di la' del nostro Io, di cio' di cui siamo convinti, di cio' di cui sono convinti gli altri, al di la' della nostra storia personale, delle sconfitte e degli allori. L'Io devo porsi come umile servo del Se', che, ripeto, al di la' della nostra idea di noi stessi, e' Colui che E'. Non conosceremo mai completamente il Se', ne' saremo mai in grado di amarlo pienamente. Ed amarlo non ci fara' grandi ai nostri ed altrui occhi. Forse anzi, per amarlo dovremmo accettare una vita molto piu' umile di quanto avevamo immaginato per noi, od una vita piu' tumultuosa e rischiosa, o piu' semplice. Anche per questo si capisce che il vero Se', proprio ed altrui, e' tanto alto e sacro quanto il Dio delle scritture. E' proprio Dio. Ed allo stesso identico modo l'Altro.

Tutti i Se' sono Dio, anche l'essenza delle pietre e particelle e' Dio. Ma e' difficile vedere Dio in una pietra. Guardando Gesu', e' invece, molto piu' facile e diretto. Per questo, la dottrina Cristiana pone Gesu', e solo Gesu' come Dio. Gesu' e' stato in questa terra un figlio di Dio, come tutti, ma lui e' stato il primo a proclamare la sacralita' della vita tutta, soprattutto quella dei piu' umili ed emarginati. Molti possono dire cose simili od uguali a lui, ma cosi' come quando si ama una canzone si preferisce andare al concerto dei cantanti originali piuttosto che a quello di una cover-band, allo stesso modo e' preferibile rivolgersi a Gesu' stesso. E Gesu' e' risorto dai morti! 

Scientificamente, nessuno puo' affermare quale sia la fede giusta, ognuno deve seguire la sua vocazione. Ma qualsiasi vocazione che ama la vita, non puo' ignorare la via di Gesu'.

Infine, Dio padre, rimane una figura trascendente, ma che rispecchia cio' che il vero Se', Dio figlio, anela ed ama. Dio padre, e' lo specchio dei limiti umani del Se' ed al contempo di cio' che oltre i suoi limiti ama. Dire, ``Tu puoi padre salvare quest'anima, Io no, sia fatta la Tua volonta' '', e' un riconoscere i propri limiti nel fare del bene verso una persona, e al contempo desiderare ed orientarsi verso il bene massimo per quella persona.

Il Se', a priori di qualsiasi desiderio, scelta ed identita, e' sacro, e' il dono piu' prezioso ed importante che Dio Padre ha posto nelle nostre mani. E lo stesso per l'Altro che ci ama. Il Se' (o l'Altro che ci ama), e' sempre pronto a tendersi e consumarsi per noi, per cio' in cui crediamo. In ogni momento che respiriamo stiamo usufruendo, della sua vita, dei suoi organi, del suo tempo e della sua fede. A volte, ci scoraggiamo perche' non abbiamo ottenuto niente o non abbiamo cio' che desideriamo, ma guardando al Se' o al Se' di chi ci ama, come un nostro genitore od una sorella, possiamo renderci conto che abbiamo gia' tutto cio' di cui abbiamo bisogno.
