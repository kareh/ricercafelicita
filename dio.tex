...
\begin{defn}
    ...
    Dopo aver parlato solo dell'essere $\esAi$, sussiste un fatto molto importante: ogni essere esistente e' Dio di se stesso, e se $A_i$ lo ama, lo considera in quanto tale. Quindi, si puo' ricorsivamente scrivere: $\anima{A}_{A_i} = \anima{A}_{A_1} + \anima{A}_{A_2} + \cdots + \anima{A}_N$.\\

Ma anche un qualsiasi essere $E$ non dell'unione $\esAi$ e' Dio di se stesso. Infatti, cio' che e' stato detto per $A_i$ vale in generale per qualsiasi essere.

    Cosa succede allora? Ci sono tre casi:
...
La scelta va' fatta da $A_i$ secondo quale delle due dara' maggiormente nutrimento ed appagamento all'Anima $\anima{A}_{A_i}$. 
