...
Prima definiamo l'insieme $\textrm{Des}(a)$ (gia' definito sopra a pagina \pageref{defDiDesideriDes}) e per assioma poniamo che e' infinito:
    ...
    A parole: esiste almeno un uomo che e' Dio, ovvero il cui amore per se stesso e gli altri, in questa natura e vita terrena, e' infinito. Tale uomo e' Gesu'. \emph{E'}, e non \emph{e' stato}, perche' Gesu' e' risorto. Altri uomini il cui amore e' infinito, ugualmente a quello di Dio, sono i santi. I santi percio', hanno pienamente lo stesso spirito di Gesu' e spiritualmente vale $U=D=\textrm{Gesu'}$. La loro anima ha trovato felicita' e pace nell'essere uguali a Gesu'. Essendo uguali a Gesu', si potrebbe pensare che come Gesu' siano loro stessi anche Dio. Tuttavia, affinche' chi li guarda veda la vera sorgente d'amore, decidono di spogliarsi di questo titolo, che non li giova a nulla se non per una piccola vanita' in confronto alle gioie dell'amore, e danno la corona di gloria solo a Gesu', figlio del Padre, padre di tutti i santi. E' come un giovane cantante che vede suonare una cover-band molto in gamba di un gruppo antico. Il cantante ne rimane entusiasta e chiede cosa stanno suonando. Se la cover-band vuole fare conoscere al cantante la vera origine e il vero significato della musica che suonano parlera' del gruppo antico al giovane cantante. Cosi' lui conoscera' il vero significato di quella musica, e potra' leggere e studiare la storia dei musicisti del gruppo antico e conoscere anche altre loro musiche. Allo stesso modo, i santi, per quanto santi, indirizzeranno i giovani fedeli a Gesu' e non a se stessi.
