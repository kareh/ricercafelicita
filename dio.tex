...
Allora, proprio per la potenzialita' della vita, vista come Se', di spendersi per i bisogni di se stessa e di altri esseri, di assumere una identita' di amore per se stessa e gli altri, la vita assume un ruolo divino. E l'Io che ama la vita, e spende la vita per la vita, e', sotto questo aspetto, esso stesso divino. In altre parole, il desiderio piu' nobile e' quello di non avere desideri ne' bisogni, al fine di mantere il Se' preservato, e questo soddisfacendoli. Un desiderio che non si esaurisce o che non potra' mai essere soddisfatto consuma il Se', senza scopo. Quindi, l'Io piu' nobile e' l'Io che agisce, pensa e spende l'anima per preservarla il piu' possibile, in ogni sua parte (il se', e gli altri).

Il Se' allora, se amiamo la vita, e' Dio che sta' con noi, in ogni momento, che e' pronto a consumarsi per i nostri bisogni e desideri. Noi, abbiamo la responsabilita' e il potere di amarlo e averne cura, ed anche la gioia di esperire le meraviglie dell'esistenza tramite i sensi.
