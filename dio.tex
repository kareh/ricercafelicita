...
\begin{defn}
    ...
    Abbiamo detto che un essere $A_i$ che rappresenta $\anima{A}$ e' ``confondibile'' con $\anima{A}$. Adesso, definiamo un essere che rappresenta perfettamente $\anima{A}$ e gli diamo il nome piu' alto: \emph{Dio}. Dio e' quell'essere che l'Anima ama certamente e di cui non smettera' mai di essere innamorata. Dio e' perfetto amante dell'Anima $\anima{A}=A_1+A_2+\cdots$, in quanto ogni desiderio e bisogno di $\anima{A}$ e' ascoltato e considerato nella giusta misura da Lui. Non solo Lui considera i bisogni e i desideri di $\anima{A}$, ma anche li soddisfa pienamente senza ledere neanche un solo $A_i$ di $\anima{A}$, incluso l'essere $N$ (la Natura). Di quest'ultimo punto parleremo successivamente quando definiremo il concetto di ``Io''.

    Detto piu' semplicemente, possiamo dire che Dio e' quell'essere la cui anima e' esattamente $\anima{A}$.
