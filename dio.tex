...
\subsection{Prima definizione di Dio}
   ...
   Se un Io lamenta che Dio non esiste, dovrebbe esaminare se stesso e vedere quanto puo' essere migliore, piuttosto che desiderare che qualcuno o qualche entita' magica, fuori da lui, risolva i suoi problemi, oppure prendersela con gli altri con la scusa che non lo amano o non lo amano abbastanza.

    La maggior parte delle volte si puo' sempre fare di piu' o diversamente, questo perche' si e' convinti che gia' si sta' facendo tutto correttamente, ma in realta' non si sta' ascoltando propriamente l'Anima, ne' si sta' spendendo se stessi per amarla. Quando gia' si stara' facendo il massimo, sara' facile confortare l'Anima con quel che si potra'.

    Amare l'Anima non e' una questione di quantita' oggettiva, ne' di risultati oggettivi. E' se l'Io esiste per l'anima amata. Che poi consumi poco o molto del suo essere, non importa, perche' e' \emph{il suo} essere, ed e' un suo dono.  Il vero problema e' che a volte l'Io crede o dice di stare amando un'anima, quando invece, non e' cosi'. Nel nostro linguaggio, l'essere $\esAi=\anima{A}_1+\anima{A}_2+\cdots$ dice di stare amando $\esAj$, quando invece, $\esAj$ non e' incluso nell'unione $\esAi$. Viceversa, $\esAj$ potrebbe essere incluso e $\esAi$ potrebbe anche non dare o fare niente di utile per $\esAj$, e in questo caso $\esAi$ sta' amando $\esAj$. Certo che, se e' vero questo secondo caso, se $A_i$ puo' fare qualcosa di benefico per $A_j$, $A_i$ lo fara'. Il punto e' pero', che dall'esterno non si puo' giudicare se $A_i$ puo' o meno fare qualcosa per $A_j$, non si puo' giudicare se $A_i$ \emph{si sente di poter fare} qualcosa per $A_j$. In termini religiosi, solo quando lo Spirito muovera' $A_i$, $A_i$ potra' fare qualcosa per $A_j$.
