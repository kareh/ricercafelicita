...
\subsubsection{Il Se', di ognuno, come Dio}
...
Introduciamo allora un nuovo concetto che e' quello del \emph{Se'}, che e' molto simile al concetto di Anima ed anche di Io di un essere. In realta', sono tutti la stessa cosa, ovvero, sono l'essere stesso, ma ogni concetto fa vedere l'essere sotto una prospettiva diversa.  Il Se' di un essere e' lui stesso a priori della sua identita' come Io. Il Se' e' l'essere considerato a priori di ogni scelta personale conscia, o di ogni scelta ormai diventata inconscia a seguito di una stratificazione di molte scelte conscie nel tempo, ma che l'essere, adesso, rinnega (sovrastrutture non sane), come ad esempio, morali repressive della societa' che l'essere ha introiettato dentro di se. Il Se' di un essere vivente e' l'essere nella sua forma che consente a lui di vivere il piu' naturalmente e piacevolmente possibile e di amare nella maniera piu' naturale e potente gli altri. 

L'Anima e' come un legno che e' stato tagliato e che e' pronto per essere modellato e mantenere una forma. Si potra' dire ``che sia un tavolo'' o ``che sia una sedia'', a seconda di quello che serve in quel momento. Allo stesso modo e' l'Anima di un essere umano, essa e' l'essere quando ancora non ha una identita'. Quando dice ``mi voglio bene'', assumera' l'identita' di una persona che ama se stessa, in formula $a_i=a_i+\cdots$, e quando dice ``ho bisogno di cibo'', assumera' l'identita' di una persona che cerca del cibo per se stessa, quando dice amo quelle altre anime, assumera' l'identita' di un'anima empatica che ama altre anime, in formula $a_i=a_i+a_1+a_2+\cdots$. Tuttavia, tra le varie possibilita' di esistenza dell'Anima, una sola e' quella per lei stessa migliore, e questa e' il \emph{Se'}. Quando l'anima e' veramente \emph{Se stessa}, si dice, allora l'anima sara' al meglio delle sue potenzialita', al massimo del piacere egoistico ed altruistico, al minimo del dolore proprio ed altrui. L'Anima non sa' inizialmente chi e' il Se', se si trovera' meglio amando poco o molto, e puo' scegliere verso quale possibilita' di esistenza indirizzarsi solo tramite la fede, tramite il credere. Non c'e' nessuno ne' niente, neanche lei stessa, che puo' stabilire a tavolino chi lei e' veramente. Quindi, l'unico modo e' il suo credere, ovvere il fare con umilta' cio' che crede sia meglio fare, l'amare ``ciecamente'' la persona di cui e' innamorata, l'applicare seriamente e costantemente cio' che crede di aver capito tramite lo studio e il dialogo, il provare con coraggio nuove direzioni, e il pentirsi di essere stata cio' che riconosce lei non e'.
...
Allora, proprio per la potenzialita' della vita, vista come Se', di spendersi per i bisogni di se stessa e di altri esseri, di assumere una identita' di amore per se stessa e gli altri, la vita assume un ruolo divino.
Il Se' allora, se amiamo la vita, e' Dio che sta' con noi, in ogni momento, che e' pronto a consumarsi per i nostri bisogni e desideri e di quelli degli altri.

Il Se', se amiamo l'Altro, non e' solo la propria persona (la ``carne'' in gergo Cristiano). L'Altro diventa una parte (infinita) del Se'. L'Altro e' il Se' che non e' esperibile tramite i propri sensi. L'Altro e' conoscibile solo tramite il sentimento d'amore, che porta ad un'altra dimensione, ad un'altra realta', che non e' quella dei propri sensi personali. 

% -- puo' essere interessante-- In altre parole, il desiderio piu' nobile e' quello di non avere desideri ne' bisogni, al fine di mantere il Se' preservato, e questo soddisfacendoli. Un desiderio che non si esaurisce o che non potra' mai essere soddisfatto consuma il Se', senza scopo. Quindi, l'Io piu' nobile e' l'Io che agisce, pensa e spende l'anima per preservarla il piu' possibile, in ogni sua parte (il se', e gli altri).

Il Se' che ama ogni Altro, e' Santo. Gesu', che e' un Se' che ha amato ogni Altro, e' Dio. Tanto piu' il Se' si fa' simile a Cristo, tanto piu' viviamo la realta' di Dio, chiamata in questo libro ``Pace'', e chiamata nella dottrina Cristiana Beatitudine.
