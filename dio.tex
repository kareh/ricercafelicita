...
Ritornando alla definizione di questa sezione, cosi' come se abbiamo un bisogno allora esiste, in qualche forma interiore, cio' che e' soluzione del bisogno\footnote{che poi si concretizzi nella realta' rispettando le aspettative in misura piu' o meno fedele}, allora esiste, in qualche forma interiore, cio' che e' Soluzione al desiderio $\des(\anima{A})$ dell'Anima, ovvero esiste Dio. Questo, pero' solo se non ci arrendiamo al fatto che ancora non abbiamo concretamente tra le mani la soluzione\footnote{e che quando la abbiamo, durera' brevemente, se non ci rimettiamo di nuovo in gioco e a disposizione}, e se avvaloriamo cio' che e' gia' parzialmente soluzione ma a cui non facciamo caso\footnote{ad esempio, che si gode di buona salute}.

``Dio esiste'' e' quindi da intendere opportunamente. Il verbo ``esistere'' non e' inteso in ``esiste un oggetto/persona fisicamente la' fuori o dentro il mio corpo che risvolera' i problemi dell'Anima''. E', invece, inteso nel senso di ``esiste una soluzione ai problemi dell'Anima, e tale soluzione, vista e vissuta come incarnata in una persona, e' vista e vissuta come realizzata, portata ed offerta da Dio''.

La definizione formale di Dio data sopra in \ref{soulGodDefition}, tuttavia non soddisfa pienamente quest'ultima affermazione. Piu' in seguito (vedi \ref{definizioneIo} pag. \pageref{definizioneIo}), definiremo l'Io. L'Io che agisce in terra per il Suo amore, e' cio' che nel concreto realizza e porta la soluzione per l'Anima, per quanto puo'. L'anima che si arrende ai limiti degli Io che amano, poi, completera' l'equazione dell'esistenza concreta di Dio. 

Cosi' Dio e' anche in tutto cio' e tutti coloro che conducono Ella alla Pace, al soddisfacimento del suo desiderio di Vita.
