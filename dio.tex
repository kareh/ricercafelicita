...
\begin{defn}
    ...
    Abbiamo parlato di Anima, come se fosse una entita' indipendente che agisce, tuttavia, e' sempre l'essere che agisce, che parla di se stesso e degli altri e della Natura, in maniera consapevole ad egli stesso od inconscia.

    L'essere e' Dio di se stesso perche' definisce e vuole il suo bene e quello di chi ama (cioe' di ogni essere $A_i$).

    Ogni essere e' un Dio di se stesso.

    Se due esseri non si amano, saranno nemici, e ognuno tentera' di affermare il suo Dio.

    Se uno ama l'altro ma non viceversa, uno stara' nel silenzio e l'altro non lo notera', ma ci sara' una sorta di pace, che tuttavia non e' guerra. Per il primo ci sara' anche la speranza che l'altro possa cambiare e ricambiare il suo amore.

    Se entrambi si amano, allora la loro anima sara' uguale e i lori animi concordi, ognuno vedra' pure nell'altro Dio, e Dio sara' uno solo.

Cio' detto vale anche per una molteplicita' di esseri $A_1,A_2,\cdots$.
