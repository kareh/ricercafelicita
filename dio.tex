...
Se consideriamo piu' di un Io santo, concluderemo che ci sono molteplici Dei? Anche se sembrano molteplici, essendo orientati all'Amore, tali Io sono concordi ed uniti. Ciascun Io si mette a servizio dell'altro Io\footnote{Vedi la ``lavanda dei piedi'' di Gesu'. Vangelo secondo Giovanni: 13,1-15}, e per ciascuno l'altro e' una parte di se stesso, e viceversa ciascuno e' una parte dell'altro. Ciascun Io santo e' quindi Dio per se e per gli altri che lo amano e, viceversa, l'altro Io santo e' per lui Dio. 
