...
L'animo $\spirit{A_i}$ e' la personificazione di $\des(A_i)$ e' un entita' che esiste fino a quando i desideri $\des(A_i)$ sono soddisfatti. L'Animo $\Animo$, inteso come l'unione degli animi $\spirit{A_1}$, $\spirit{A_2}$, $\cdots$,  desidera che tutta e sola l'unione dei desideri di ogni $A_i$ sia soddisfatta, dando piu' priorita' ai bisogni ed ai desideri che lui considera non superflui che agli altri desideri.

Un Io $A_i$ ama $\anima{A}$ quando spende $\anima{A}$, affiche' questi desideri siano soddisfatti, o detto in altro modo, affinche' l'Animo $\Animo$ sia soddisfatto.\\
