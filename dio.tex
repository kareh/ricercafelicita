...
Un'anima $d$, che ama perfettamente tutta l'Anima $\anima{U}$, e' Dio, come anima (non come Spirito), e vale $d=a_1+a_2+\cdots+N+\cdots=\anima{U}$. Tale anima non esiste in terra, non puo' esistere fisicamente, ne' in alcun modo sensibile per un essere umano. Tuttavia tale anima, e' il limite all'infinito di ogni anima $a_i$ che tende ad amare $\anima{U}$. Questo limite, anche se non fisico, esiste metafisicamente perche' rappresenta la realizzazione piu' vera, piena e naturale di ogni $a_i$. Nella vita fisica, $a_i$ non potra' amare perfettamente con la mente, il corpo e la sua psiche tutta l'anima $\anima{U}$. Tuttavia, $a_i$ e' sempre orientato a tendere nell'essere una incarnazione e manifestazione di $d$. Quando $a_i$ raggiunge la sua perfezione e completezza $d_i$, allora e' da considerarsi comunque Dio, incarcanato in Terra, come uomo. Allora, $d$ e' \emph{Dio Padre della Trinita'}, mentre $d_i$ e' un $\emph{Santo}$. Gesu' $g$, e' il santo dei santi, ed e' \emph{Dio Figlio} della Trinita'. 
...
Inoltre, possiamo vedere fisicamente l'immagine di Gesu' in ogni persona che ama $\anima{U}$, e questo, tanto piu' una persona ama se stessa e gli altri, come lui ha amato tutti. Ad esempio, nella lotta non violenta di Gandhi contro il potere, si rivede l'ascesa non violenta allo stato di re dei credenti di Gesu'.

Poiche' i santi e Gesu' amano l'Anima, si ha che ognuno di essi approssima molto bene $\anima{U} $\eal{&g=s \simeq \anima{U}\;\;\textrm{per ogni santo $s$}} Quindi, la loro anima e' a tutti gli effetti una, e tutta e solo l'Anima. Tuttavia, solo Gesu' ha l'onore di essere chiamato Dio. Questo perche' la missione di Gesu' e' proprio quella di chiamare gli uomini a se, per essere il loro re, il loro punto di riferimento e la loro unica santa guida. Il vantaggio del monoteismo e' che il fedele puo' concentrarsi piu' semplicemente nello sviluppo della sua identita', senza frammentarla in varie parti, ma cercando sempre una unita'. Quindi, Gesu', mantiene l'unita' e unicita' di Dio Padre, in terra, e per questo puo' esistere un solo uomo che e', a tutti gli effetti, Dio. Gli altri uomini che approssimano molto bene $\anima{U}$, i santi, continuano la missione di Gesu', e non cercano di chiamarsi, per vanita' e gloria, Dio. Inoltre, essendo Gesu' risorto, Egli continua sempre la sua missione di chiamare a se' gli uomini tramite i santi, i suoi ministri e la carita' dei suoi fedeli.
