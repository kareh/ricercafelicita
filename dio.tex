...
Consideriamo l'Anima $\anima{A}=a_1+a_2+\cdots+N+\cdots$, che include tutti gli esseri umani e la Natura. La volonta' di Dio, come Spirito (precedente paragrafo \ref{DioComeSpirito}), e' quella di soddisfare e realizzare i desideri e bisogni di $\anima{A}$ necessari o non superflui. $\anima{A}$ e' il fine dell'esistenza dello Spirito, quindi e' essa stessa divina, figlia o figlio amato di Dio. 

I suoi desideri e bisogni sono amati da Dio, anche quelli cattivi e odiosi. Dio, non giudica, ne' sentedosi superiore obbliga l'Anima ad essere diversa da quella che e', in ogni sua parte $a_i$. Dio, agli occhi dell'Anima, e' talmente bello, giusto, e vero, che l'Anima, riconoscendolo, capisce che puo' essere diversa e, cosi', trovare pace.

Un Io $a_i$, che ama tutta l'Anima, $a_i=\anima{A}$, e' esso stesso Dio, nei suoi limiti umani. Un esempio, e' Gesu'. Per indicare Gesu', usiamo la lettera $g$. Un qualsiasi altro Io che ama tutta l'Anima e' \emph{santo}. Poiche' i santi e Gesu' amano l'anima, si ha $g=s=\anima{A}$ per ogni santo $s$. Quindi, la loro anima e' una, e' tutta e solo l'Anima. Anche per questo, Gesu' vive ancora ogni qualvolta si manifesta un santo nel mondo.

Un santo $s$, e' un essere umano. Quindi, la sua anima, in verita', approssima $\anima{A}$, cioe' $s\simeq\anima{A}$. Nei suoi 7 peccati giornalieri, non riesce ad includere in se stesso completamente ed amare almeno un essere $a_i$. 
Tuttavia, la sua natura di essere umano che ricerca e sceglie il bene per se e per gli altri, fa' tendere se stesso all'anima $\anima{A}$, che e' il suo vero centro.

Un essere $d$ la cui anima e' esattamente $\anima{A}$ e' \emph{Dio Padre}. L'anima di un santo $s$, tende a diventare $\anima{A}$, quindi $s$ tende a diventare una piccola incarnazione e manifestazione di Dio in terra.
...
Per questo motivo, $d$ non puo' essere una figura creata ad arte da regole e norme religiose. $d$ e' il limite ed il centro piu' vero e vitale di ogni essere $s$ che ricerca il Bene. Come la storia insegna, e Gesu' stesso ha insegnato, non sempre la figura di Dio tramandata dal mondo e' quella vera di Dio. Tuttavia, nel tempo storico odierno, e' anche vero dire che gran parte della figura che viene tramandata dalla Chiesa e da altre tradizioni, e' veritiera: non si puo' raggiungere la santita' se si predilige il proprio Io su quello degli altri, non si puo' vivere in pace nella societa',  se non si accetta di doversi sacrificare per il bene degli altri, per quanto gli altri possono apparire in errore ai nostri occhi, e che la societa' non e' un strumento ad uso e consumo esclusivo nostro.

La differenza tra un essere $s$ che ama $\anima{A}$ ed un essere umano $a_i$ qualsiasi e' che il secondo oscilla tra il voler amare e non amare $\anima{A}$, mentre il primo, ha scelto di amare e solo amare e trova in cio' la sua identita' e pace.

Esplicitiamo che amare $\anima{A}$ vuol dire amare ogni essere $a_j$ vivente e non vivente, incluso l'ambiente naturale $N_j$ di ogni essere $a_j$. 

Un essere santo $s$ e' una piccola e concreta dimostrazione dell'esistenza di Dio Padre, di un essere che anima l'Anima ed esiste per donarle Pace. 
...
Un Io $a_i$ che e' in \emph{Pace Universale}, e' per se stesso e per chi lo ama, Dio. Bisogna vedere pero' che tipo di Dio, un Dio del bene o del male.

Un Io $a_i$ e' in Pace quando e' in pace con ogni altro Io $a_j$, che e' esistito, che esiste ed esistera', inclusa $n$ la Natura, considerata come Io. Si puo' pensare che questo accade quando ogni desiderio forte o debole di ogni $a_j$, non turba $a_i$. Alcuni desideri di alcuni $a_j$, invece, daranno gioia ad $a_i$.

Per raggiungere una tale Pace, i desideri stessi di $a_i$ devono essere concordi, o quantomeno non interferenti con i desideri degli altri Io $a_j$. In formula, quando ogni $r\in\des(a_i)$ e' concorde con ogni $s\in\des(a_j)$, per ogni $j$. 
...
Ancora, piu' astrattamente, se $a_i$ ama $a_j$, $a_i$ sara' l'anima $a_i=a_i+a_j$. Se $a_i$ ama tutti gli esseri, allora $a_i=a_1+a_2+\cdots$, e quindi $a_i=\anima{A}$, dove $\anima{A}$ e' l'Anima Universale.

La via del male e' annullare e distruggere i desideri degli altri $a_j$ al fine di mantere i desideri propri di $a_i$ e cosi' non avere niente che interferisca con loro. E' inoltre, obbligare ed annullare gli altri esseri, al fine di rendere $a_i=\anima{A}$, avendo reso zero $a_1,a_2,\cdots$ per ogni $a_j\ne a_i$. 

La via del bene per $a_i$, e' invece, quella di dialogare, pregare, sopportare e, se necessario, rinunciare ai desideri superflui e non necessari, come insegna Epicuro. In alcuni casi, l'Io deve sacrificare dei desideri anche necessari o non superflui, come insegna Gesu'. La via del bene, e' accogliere tutti gli esseri nella propria anima.

Un Io $a_i$ che e' in Pace, secondo la carita', e' il Dio dei Cristiani. Una tale Io e' Gesu'.

Gli altri Io che sono in Pace secondo la carita', sono sempre Dio, ma per unita' di Anima, come visto varie volte nei precedenti paragrafi, sono sempre uguali tra loro. Per questo Gesu' risorge ogni qualvolta un Io raggiunge la Pace secondo la carita'.
...
Tanto piu' liberiamo noi stessi da pesi superflui, vani e che ci allontanano dalla nostra natura divina, e tanto piu' ameremo gli altri come noi stessi, tanto piu' noi saremo una incarnazione di Dio in Terra e noi stessi e gli altri ne trarranno beneficio.
...
Un'uomo e' un essere vivente, limitato nella sua psico-fisicita', quindi non potra' mai amare tutti gli esseri con ugual facilita' e profondita'. Tuttavia, la sua natura, nel bene, e' quella di andare sempre oltre e crescere nella direzione dell'amore. \emph{Dio Padre}, da questa angolazione, e' allora l'essere umano che ama nella sua proiezione naturale all'infinito. \emph{Dio Figlio} e' l'essere umano, che ama, con le sue forze psico-fisiche.
