...
\begin{defn}
    Abbiamo detto che un essere $A_i$ che rappresenta $\anima{A}$ e' ``confondibile'' con $\anima{A}$. Adesso, definiamo $D$ come quell'essere che rappresenta perfettamente $\anima{A}$ e gli diamo il nome piu' alto: \emph{Dio}. Dio e' esatta immagine ed oggettificazione di $\anima{A}=A_1+A_2+\cdots$.
