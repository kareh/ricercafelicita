...
Se consideriamo piu' di un Io santo, concluderemo che ci sono molteplici Dei? Anche se sembrano molteplici, essendo orientati all'Amore, tali Io sono concordi ed uniti. Ciascuno Io si mette a servizio dell'altro Io\footnote{Vedi la ``lavanda dei piedi'' di Gesu'. Vangelo secondo Giovanni: 13,1-15}, e per ciascuno l'altro e' una parte di se stesso, e viceversa ciascuno e' una parte dell'altro. Ciascuno Io santo e' quindi Dio per se e per gli altri che lo amano e, viceversa, l'altro Io santo e' per lui Dio. 
...
Lo Spirito Santo e' la parte santa del nostro Io, ed e' gia' presente in quella parte che ci fa respirare tranquillamente. Questa e' una parte che da' pace (il respiro) e non chiede ne' toglie alcun che' agli altri, mantenendo cosi' la loro pace. Ogni persona ha poi delle doti, presenti o potenziali, che portano pace e gioia a se stesse e agli altri, questo e' sempre lo Spirito Santo.

Il Padre e' l'Io santo che ama al di la' di cio' che e' realizzabile in terra nel presente. Per questo il Padre e' nei cieli\footnote{espressione tratta dalla preghiera ``padre nostro''}. Se l'Io ama al di la' di quello che puo' realizzare, e nonostante raggiunti i suoi limiti fisici continua ad amare, allora l'Io si unisce totalmente al Padre. La meta della santita' consiste nel ricercare il Padre gia' in terra, ed essere una cosa sola con Lui.
