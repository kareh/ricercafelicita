...
Tutto quanto detto e' una visione a livello macroscopico. A livello microscopico, uno puo' cercare nel proprio quartiere, nei quartieri vicini, o nei paesi vicini una parrocchia con una comunita' in cui si ci trova bene.

Nella mia esperienza, ho trovato nel gruppo del Rinnovamento nello Spirito Santo\footnote{\url{https://it.wikipedia.org/wiki/Rinnovamento\_nello\_Spirito\_Santo}} di una parrocchia consigliatami da una Suora amica di mia madre, un ottimo ambiente, molto al di la' dei pregiudizi comuni sulla chiesa.

In secondo luogo, se si e' mossi da un autentico spirito di ricerca e di fratellanza con gli altri, e' molto facile mangiare e pregare come gli altri. Ogni rito, se eseguito con fede, e' espressione di cio' che l'uomo ha dentro di se'. E poco importano le sottigliezze come il dire se la Terra gira intorno al Sole o viceversa, quando cio' che si sta' insieme cercando e' molto piu' importante.
