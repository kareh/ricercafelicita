...
Per dare l'idea, ``Dio'' e' colui che conduce alla pace interiore, seduce l'esteriore ad accogliere la pace nella propria vita, e' colui che conduce al piacere ed all'amore. Qualunque proprieta' positiva e che conduce alla Vita, e' Sua: saggezza, grazia, verita', grandezza, bellezza. Non esistono forze e fenomeni che non rispettino o accadino secondo la Sua volonta'. Nulla lo turba e inquieta. Ogni cosa della Natura e', semplicemente od intelligentemente, una risorsa utilizzabile per chi ama. Per amare chi ha bisogno di Lui sacrifica ogni parte del suo essere.

Nel rigore logico, non stiamo indicando alcuna entita' esistente od immaginaria come Dio. Stiamo solo dicendo che qualunque entita' rispetti la definizione data di Dio, e' Dio, nella misura dei suoi limiti. Ad esempio, il panettiere sara' un bravo artigiano e il suo pane sara' nutriente e saporito. Tuttavia, il suo pane non bastera' a raggiungere la Pace.
...
Definiamo \emph{Io} di un essere come quell'entita' che amministra il potere che quell'essere detiene nelle sue mani. Se l'Io e' \emph{sano}, tale potere sara' utilizzato per soddisfare il desiderio degli animi di proteggere, curare e dare piacere all'Anima.

L'Io essendo il prodotto di processi neurologici, e' limitato ed imperfetto. Tuttavia, tende ad un punto fisso, un punto di equilibrio, di massima realizzazione. Ogni anima ha bisogno e desidera costantemente che l'Io lo raggiunga. Questo punto fisso e' Dio. Un essere umano non e' un essere infinito, ha limiti fisici e psicologici, quindi il punto fisso e' per un uomo un punto posto a distanza infinita, e quindi mai pienamente raggiungibile. Pero', tanto piu' un uomo si avvicina ad esso, tanto piu' esponenzialmente l'Anima ne trae benefici. Gesu', i Santi e molti grandi uomini nella storia ne sono la prova. 

Esempio: se l'Anima e' empatica, tendera' ad amare le altre anime. Il punto fisso di un qualsiasi Io che la ama sara' raggiunto quando esso permettera' all'Anima di amare tutte le altre anime, in completezza, in tutti i momenti. Un esempio semplice: 

Il punto fisso sara' l'unione infinita A+B+C+... degli esseri e Dio per lei sara' un essere che ama pienamente ogni essere.
