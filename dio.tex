...
Quanto detto sopra in \ref{DioScientificamentePsicologicamente}, si puo' riassumere in ``l'Io santo e' Dio Spirito Santo''. Lo Spirito Santo in un uomo e' parte infinita dell'infinito Dio Padre. Tuttavia, lo Spirito Santo in un uomo non potra' mai essere identico a Dio Padre, cosi' come l'insieme dei numeri pari e' infinito, ma non e' identico all'insieme di tutti i numeri. Anche perche', si puo' sempre ambire ad una perfezione, sensibilita', cura, forza e rifinitezza maggiore. Percio' un uomo santo puo' sempre ambire ad una santita' maggiore, che puo' trovare solo in Dio Padre. Dio Padre, non e' un semplice ideale di perfezione e infinito. La santita' di Dio Padre e' concreta e realizzabile in un uomo! In maniera naturale e appagante per l'anima dell'uomo. In altre parole, Dio Padre puo' trovarsi pienamente nel cuore di un uomo, anche se quell'uomo, per la sua natura umana, non potra' vedere realizzato nella sua vita tutto cio' che il Padre realizzera'.

Un altro ragionamento da considerare, oltre ai limiti e all'infinito, e' che l'amore e' dinamico. Per amare, bisogna cambiare, sempre. Se dicessimo ``Io ho amato ora e per sempre'', smetteremmo di amare, se dicessimo ``Io sono Il Camminatore, che ha camminato per tutti i cammini che esistono'', smetteremmo di camminare. Allo stesso modo dire ``Io sono il Padre'', equivarrebbe a smettere di vivere, perche' cosi' avremmo gia' completato la vita. Invece, la vita porta sempre nuove sfide, nuove persone da amare, e nuovi modi per amare. E per ogni novita', ci ritroviamo ad essere piccoli di fronte ad essa.

Lo Spirito Santo e' mandato nei tempi e nei modi stabiliti dal Padre, e cosi' e' potente ed equivalente al Padre, ma un uomo non sara' mai totalmente il Padre. Solo quando Gesu' ritornera' nella fine dei tempi, e ogni malattia e morte, di ciascuno, sara' definitivamente sconfitta, Gesu' sara' esattamente il Padre.
