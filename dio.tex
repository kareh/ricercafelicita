...
\end{align*}
    ...
    \begin{enumerate}
        ...
        \item    Se entrambi si amano, allora la loro anima sara' uguale e i lori animi concordi, ognuno vedra' pure nell'altro Dio, e Dio sara' uno solo. 
                ...
                In formula: $\anima{A}_i = \anima{A}_j$ per ogni $a_j$ di $\anima{A}_i$.
...
Osservazione: il caso $2$ e' superiore al caso $1$ perche' trovo che il resterare in pace con gli altri permette piu' facilmente di restare in pace anche con se stessi. Usando le notazioni di prima: se $a_i$ e' in pace con $E$, anche se $E$ non ama $a_i$, $a_i$ puo' piu' facilmente amare $\anima{A}_i$, perche' la sua natura umana sociale ne trae beneficio. Secondo la fede Cristiana, essere caritatevoli anche verso il prossimo che non ci ama e' l'unico modo per amare Dio.

Osservazione: anche se un essere $a_i$ ed un essere $a_j$ si amano, nel caso $3$, per $a_i$ non cambia molto dal caso $2.$. Infatti, come osservato, comunque le situazioni della vita, i desideri di $a_j$ e proprio il suo amore per $a_j$ potrebbero comportare dei sacrifici per $a_i$ piccoli o grandi. Allora, si capisce di piu' che la questione per $a_i$ e' indipendente da quello che fara' il suo prossimo. $a_i$ deve solo scegliere se amare o meno il suo prossimo, indipendentemente dalla scelta dell'altro.
...
Se il risultato della sua scelta dara' buoni risultati, l'essere $a_i$ tendera' maggiormente a vivere la ``Pace di Dio''. Lui si sentira' in pace con se stesso e con chi ama, e con gli esseri che ricambiano il suo amore sara' Dio per loro e loro Dio per lui.

Come fa' una donna od un uomo ad essere Dio, anche se solo di se stesso ? Un essere umano e' un qualcosa di finito, Dio e' infinito. Nella definizione di sopra abbiamo attenzionato l'Anima dell'essere $a_i$, non il suo Io umano. L'Anima e' infinita, come postulato all'inizio del capitolo. I desideri di $\anima{A}_i$ sono infiniti in dimensione e potenzialmente in numero, ed essi sono tutti i desideri di ogni $a_j$ dell'unione. L'Anima desidera tutto il bene, e se raggiunto un certo livello di bene, desidera un livello maggiore. Per desiderare deve essere desiderio, e quindi per aumentarlo si ingradisce pure lei. Per soddisfarlo, consuma se stessa e chi la ama. Ogni consumo del corpo suo e di chi la ama, e' una spesa infinitamente grande, dato che ogni sua particella e' sacra (vedi poesia in pagina \pageref{bruciamoComeLegna}).  Percio', l'Anima e' infinita.
