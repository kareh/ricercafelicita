...
Come fa' una donna od un uomo ad essere Dio, anche se solo di se stesso ? Un essere umano e' un qualcosa di finito, Dio e' infinito. Nella definizione di sopra abbiamo attenzionato l'Anima dell'essere $A_i$. L'Anima e' infinita, come postulato all'inizio del capitolo. I desideri di $\anima{A}_{A_i}$ sono infiniti in dimensione e potenzialmente in numero: essi sono tutti i desideri di ogni $A_j$ dell'unione. L'Anima desidera tutto il bene, e se raggiunto un certo livello di bene, desidera un livello maggiore. Per desiderare deve essere desiderio, e quindi per aumentarlo si ingradisce pure lei. Percio', l'Anima e' infinita.
