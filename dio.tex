...
Allora, proprio per la potenzialita' divina della vita dell'essere di spendersi per la vita di se stesso e di altri esseri, di assumere una identita' di amore per se stesso e gli altri, il Se' assume un ruolo importante.
