...
Facciamo un esempio per concludere questo paragrafo: un ragazzo dice ``mio padre mi fa passare i pomeriggi a studiare duramente, e' oppressivo ed io sono troppo scarso e debole''. Dicendo cosi', il ragazzo sta' totalmente attribuendo la responsabilita' di quello che gli succede a suo padre, in piu' non tollera di vedersi in difficolta', ne' riesce a vedere obbiettivamente suo padre come persona e a cosa sta' ambendo. Se, invece, fosse maturo nell'amare se stesso, potrebbe dire 
``Io mi fido di mio padre, che credo mi stia guidando nella mia crescita, e per il mio avvenire. Sto' studiando ogni pomeriggio, intensamente, per ascoltarlo. Tuttavia sto' soffrendo. Io voglio essere libero, studiare senza soffrire e vivere semplicemente. Mio padre, tuttavia, forse vuole raggiungere un altro obbiettivo, che non coincide con il mio''. 
Capito, questo, potrebbe poi parlarne col padre. Il padre potrebbe capire le difficolta' del figlio ed andargli incontro, spiegargli perche' lui vuole che studi, anche al costo di sacrifici. Se gli obbiettivi del padre sono centrati nell'avvenire del figlio, e sono sani, il padre e il figlio, dialogando, esponendo ciascuno le proprie esigenze e speranze, raggiungeranno una compresione reciproca e cosi', sicuramente, per il figlio non sara' piu' cosi' pesante studiare. 
Il padre, pero', potrebbe anche rendersi conto che i suoi obbiettivi non sono gli obbiettivi di vita del figlio \footnote{anche utilizzando tutta la conoscenza della psicologia, della neurofisiologia cerebrale e del vivere nel mondo, non si amerebbero i propri figli se non avessero liberta'. Come dice Richard David Precht, ``posso volere cio' che voglio? E' vero che la psicologia-positiva [e' un insieme di regole efficaci per raggiungere la felicita'], ma [comunque non risolve il punto fondamentale della liberta']. A cosa mi servono [le direttive e le regole] piu' intelligenti [e piu' giuste] se non sono libero di metterle in pratica?'' Vedi libro di Richard David Precht, ``Ma io chi sono? (ed eventualmente, quanti sono?)''}.
Se il figlio, rimane radicato in se stesso, esponendo le sue difficolta', il padre vedra' che cio' che chiede sono sacrifici inutili, e che il figlio potrebbe vivere piu' serenamente, maturando lentamente nel tempo, ed avere comunque un avvenire radioso.
Infine, il padre potrebbe non capire le esigenze del figlio, rimanere duramente radicato nelle sue ambizioni. Anche se cosi' fosse, il ragazzo sarebbe gia' a meta' dell'opera. Infatti, comprendendo che non e' giusto studiare immoderatamente, ma che e' anche importante riposarsi, e crescere anche in altri aspetti della vita, facendo esperienze diverse, e pur comprendendo che e' importante studiare per il suo avvenire, potrebbe prendere in mano la situazione e scegliere con responsabilita' per se stesso. 
La situazione potrebbe evolvere in mille modi, dal collaborare con compagni nello svolgimento dei compiti in eccesso e nel migliorare e sviluppare tecniche per fare piu' compiti in maniera piu' efficiente, al parlare con i propri professori della sua difficolta'.
Infine, raggiunti dei risultati gia' buoni a scuola, potrebbe rifiutarsi con consapevolezza di perfezionare lo studio, andando oltre i suoi limiti, essendo gia' fiducioso di stare facendo il necessario per il suo avvenire, e avendone conferma tramite il feedback di suoi amici che studiano con serieta', e avendone conferma dal feedback dei professori. Ad ogni modo, non dipendendo esclusivamente dal padre per amare se stesso, ne' pretendendo di essere infallibile per amare se stesso, ritornerebbe a vivere, smettendo di covare solo risentimenti e trovando vere soluzioni.
