...
In noi pero' esiste una via d'uscita da questo abisso nichilisitico che conduce al nulla e alla morte.
In noi risiede la potenzialita' dell'\emph{essere}, e in particolare di essere santi.
La santita' consiste nell'apprezzare l'esistenza, la vita in se, e apprezzarla ogni giorno che passa sempre di piu'. Nella santita', i piaceri, quando possibili, saranno buoni, belli, intensi o leggeri, ma non saranno fondamentali per l'esistenza. La gloria e la ricchezza umana, sara' auspicabile e benefica, ma non sara' fondamentale per la vita. L'unico aspetto fondamentale sara' la vita stessa.\\
La santita' e' la meta piu' difficile che esista per l'uomo, infatti, come e' possibile considerare importante noi stessi e gli altri, che siamo un pugno di sabbia soggetto ad ogni genere di problemi, e sorgente di ogni genere di fastidi e pericoli per noi stessi e per gli altri? Come e' possibile considerare addirittura sacro questo pugno di sabbia? Un aiuto per l'uomo consiste nell'amore, ovvero nel non vivere solo per se stessi, ma nel riconoscere importante anche la vita altrui, e sviluppare questa riconoscenza in relazioni umane, fatte di emozioni, sentimenti e volonta'. L'amore e' il vero primato dell'uomo nell'Universo. 

Un riflesso della nostra potenzialita' divina, si vede in noi che avendo cognizione dell'ambiente che ci circonda, di come noi stessi stiamo e di come stanno gli altri uomini, abbiamo emozioni che ci fanno essere felici o tristi, carichi o demoralizzati. Abbiamo la liberta' di scegliere di che farcene della nostra cognizione e delle nostre emozioni. Possiamo direzionare la nostra vita verso la creazione di un paradiso terrestre, o abbandonare tutto e tutti e lasciare che la terra si trasformi in un inferno terrestre. Niente nell'Universo, per quanto potente, ha queste potenzialita'. Ad esempio, nessun elemento della natura, ne' alcuna macchina artificiale, ha una sua volonta'. Ogni elemento della Natura agisce seguendo ciecamente delle leggi fisiche, senza liberta' alcuna, e allo stesso modo ogni macchina artificiale, agisce seguendo degli obbiettivi che sono stati preimpostati in lei dall'uomo e che saranno per sempre quelli, anche se la macchina dovesse automodificarsi\footnote{Se la macchina si automodifica, quale criterio di modifica segue se non uno coerente con gli obbiettivi iniziali per cui e' stata programmata?}. Inoltre, le macchine, essendo create per essere usate, senza emozioni non le importa se venga distrutta essa stessa o se i suoi simili vengano distrutti. Non conosce la gioia, sua, e di niente e nessun altro. \\
