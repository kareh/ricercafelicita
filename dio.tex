...
\begin{defn}
    ...
    Ricapitolando, Dio e' un essere $D$ tale che $\sigma_{D}(A_j)=100$ per ogni $A_j$, in ogni momento presente, passato e futuro. Possiamo inoltre definire un'Anima $\anima{A}$ universale come: $\anima{A} = \anima{A}_D$.

    Un essere vivente incarna Dio per una certa approssimazione, i Santi in ottima approssimazione, ma nonostante cio', Dio e' reale perche', $\anima{A}_{A_i}$ e' reale e viva per ogni $A_i$ vivente, i suoi bisogni e desideri sono veri, necessari e non superflui, e perche' $\anima{A}$ e' la realizzazione piu' sana, forte ed autentica di $\anima{A}_{A_i}$.
...
La definizione formale di Dio data sopra, tuttavia non soddisfa pienamente quest'ultima affermazione. Piu' in seguito (vedi \ref{definizioneIo} pag. \pageref{definizioneIo}), definiremo l'Io. L'Io che agisce in terra per il Suo amore, e' cio' che nel concreto realizza e porta la soluzione per l'Anima, per quanto puo'. L'anima che si arrende ai limiti degli Io che amano, poi, completera' l'equazione dell'esistenza concreta di Dio. 
