...
\begin{defn}
    ...
    Infine, Dio e' reale: un essere vivente incarna Dio per una certa approssimazione, i Santi in ottima approssimazione. Ed anche perche' $\anima{A}$ e' la realizzazione piu' sana, forte ed autentica di $\anima{A}_{A_i}$, per ogni $A_i$ vivente, poiche' tutti i suoi bisogni e desideri sono veri, necessari e non superflui.
