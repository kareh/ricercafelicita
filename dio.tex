...
L'Anima in Pace e' una, ``piccola'' incarnazione, di Dio in terra.

L'Anima $\anima{A}$ e' in Pace quando e' in pace con ogni sua parte $a_i$, incluso $n$ la Natura. Questo accade quando ogni desiderio forte o debole di $\anima{A}$ e' concorde o non interferente con ogni suo altro desiderio. In particolare, quando un $d_i\in\des(a_i)$ e' concorde con un qualsiasi altro $d_j\in\des(a_j)$. Anche il caso $i=j$ e' incluso: se $a_i$ ha problemi interiori psicologici lievi, come stress, o piu' gravi, ha almeno due desideri $d_1,d_2\in\des(a_i)$ che non sono concordi.
...
In alcuni casi, l'anima $\anima{A}$ deve sacrificare dei desideri anche necessari o non superflui, come insegna Gesu'.

La Pace dell'Anima, si raggiunge quando ognuno raggiunge il proprio ``centro''. Questo centro e' la parte essenziale e vitale dell'individuo, ed essendo di natura divina, e' proprio Dio. Ad esempio, il desiderio di amore verso una persona in difficolta', disposta a collaborare per risolvere il suo problema, e' un desiderio di Dio stesso.

Questo mostra che Dio, non e' una entita' fuori da noi, ma e' in noi, noi siamo fatti di Lui stesso.
...
Un'Anima in Pace e' sempre un essere vivente, quindi non potra' mai amare tutti gli esseri con ugual facilita' e profondita' ognuno di essi. Da questo discende la definizione di \emph{Dio Padre}, come quell'Anima (celeste) che ama infinitamente.

Dio Padre non e' un ideale, ogni Anima in Pace e' una piccola dimostrazione della Sua esistenza. Tante piu' anime saranno in Pace, tanto piu' sara' evidente la Sua esistenza.
