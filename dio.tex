...
\subsection{Il Se' e Dio}
Abbiamo detto che Dio e', dal punto di vista di un'anima $a_i$, il limite della sua realizzazione, per il suo amore che tende all'infinito. Un altro approccio alla questione e' notare che Dio e' gia' presente in $a_i$. In ogni respiro che $a_i$ compie, $a_i$ ha la possibilita' di scegliere se amare o no (incosciamente e consciamente), se vivere o no. Questa possibilita', gliela da' il Dio che e' gia' presente in se stesso. Nel tempo, diventando sempre piu' fermo nello scegliere l'amare e piu' bravo nell'esprimere l'amore, $a_i$ tende sempre meglio a manifestare questo Dio, cosi' come abbiamo detto nella Seconda definizione di sopra.

Quindi, introduciamo un nuovo concetto che e' quello del \emph{Se'}. Il Se' di un essere vivente e' l'essere considerato a priori di ogni scelta personale, inconscia o conscia, ed a priori della sua identita' come Io. Il Se' e' come un legno che e' stato tagliato e che e' pronto per essere modellato e mantenere una forma. Si potra' dire ``che sia un tavolo'' o ``che sia una sedia'', a seconda di quello che serve in quel momento. Allo stesso modo e' il Se' di un essere umano, esso e' l'anima quando ancora non ha una identita'. Quando dice ``mi voglio bene'', assumera' l'identita' di una persona che ama se stessa, in formula $a_i=a_i+\cdots$, e quando dice ``ho bisogno di cibo'', assumera' l'identita' di una persona che cerca del cibo per se stessa, quando dice amo quelle altre anime, assumera' l'identita' di un'anima empatica che ama altre anime, in formula $a_i=a_i+a_1+a_2+\cdots$.

Percio', definiamo matematicamente il Se', come l'insieme vuoto: $d=\{\}$. L'insieme vuoto, non contiene nulla, neanche il proprio Io, i propri bisogni o desideri, ne' i bisogni o desideri di altri. L'insieme vuoto ha la potenzialita', a seconda dei desideri o dei bisogni dell'Io o di Altri, di contenere entita' che personificano questi bisogni e desideri, ovvero le anime. Quindi, quando un'anima ama se stessa, l'insieme vuoto diventa un'altro insieme che contiene lei, i suoi bisogni e desideri\footnote{in effetti, si potrebbe pensare di migliorare il capitolo Procedimento assiomatico, ponendo che $\des(a_i)$, l'insieme dei desideri forti o deboli di $a_i$, sia proprio $a_i$}. Quando un'anima ama anche altre anime, ancora diventa un altro insieme che contiene loro.
