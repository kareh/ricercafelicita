...
\begin{vcentered}
    ...
    \begin{poem}
        ...
        Non chiedere di piu' di quello \\
        che gia' con fatica facciamo,\\
        come noi non chiediamo di piu' agli altri.\\
        Non abbandonarci alla tentazione,\\
        al cambiare facilmente la nostra identita'\\
        in nome di occasioni piu' facili, piu' belle,\\
        presenti o future, occulte agli altri, o in mostra,\\
        piccole e temporanee, o grandi e immodificabili,\\
        ma che, in almeno un loro piccolo accenno velato,\\
        si intravede la loro inconsistenza, mancanza di amore,\\
        infedelta' al prossimo, o a se stessi.\\
        Liberaci da ogni male,\\
        sia fisico, sia psicologico,\\
        affinche' possiamo pienamente gioire con Te.\\
    \end{poem}
