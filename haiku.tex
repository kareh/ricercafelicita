...
Non seguire l'esempio del mondo,\\
    che per paura di vedere la propria miseria, \\
    debolezza e infermita', \\
    cerca vane vie.\\
    Si fa onnipotente nel dominare la materia morta,\\
    si fa libero nel perdersi, \\
    si fa sapiente di scienze senza cuore, \\
    si nutre di piaceri che ad ogni pasto lo lasciano piu' affamato di prima, \\
    si fa bello di fascini illusori e di successi fugaci, \\
    si proclama giusto ma il suo cuore e' duro come la pietra.
\end{vcentered}
