...
\begin{vcentered}
Dio e' quell'unico essere $D$ tale che, la sua funzione di scelta $C$ sullo spazio di fase $\Omega$ e' tale che
    \begin{align*}
        &\forall a \in \textrm{Anima}\;\;\forall b \in \textrm{Des}(a)\;\;b(C(\Omega))= \{0\}
    \end{align*}
    Vedi \ref{SecondaDefDivertendociConLeFormule} pag. \pageref{SecondaDefDivertendociConLeFormule}
\end{vcentered}
