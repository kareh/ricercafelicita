...
\centerpoemon{dove il singolo e' contrito}
\begin{haiku}
    Tu sei,\\
    l'unico Io,\\
    centrato sull'Anima,\\
    dell'umanita',\\
    sui suoi bisogni\\
    e desideri necessari.\\
    Tu sei,\\
    reale dove due o tre\\
    sono riuniti nel tuo nome,\\
    dove il singolo e' contrito\\
    nel suo cuore,\\
    o bruciante di Carita'.\\
    Tu sei,\\
    quando non qui,\\
    nei cieli,\\
    speranza dell'Anima,
