...
\begin{vcentered}
    ...
    Definiamo \emph{Dio} come quell'essere $D$ tale che il suo amore e' infinito:
    \begin{align*}
        &\textrm{amore}(D) = \infty
    \end{align*}
    Equivalentemente, prima definiamo l'insieme $\textrm{Des}(a)$ e per assioma poniamo che e' infinito:
    \begin{align*}
    ...
    \end{align*}
    (Vedi nota sul ``soddisfare'' un desiderio\footnote{desiderio ``soddisfatto'' non vuol dire che si realizza alla lettera, ma vuol dire che il bisogno dell'anima che sottende tale desiderio e' soddisfatto o lenito a tal punto da poterne fare a meno, se non e' lecito che sia realizzato}.)\\
