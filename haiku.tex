...
\centerpoemon{di vuota materia e fredde luci,}
\begin{haiku}
    Ecco,\\
    Ti intravidi,\\
    un po' guerriero,\\
    ...
    scassinare.\\
    Son io stesso,\\
    il ferro da plasmare.\\
    Chiave per aprire\\
    la porta\\
    del Tuo regno.\\
    \leavevmode\\
    Deforme ti cercavo\\
    appesantito, abbagliato\\
    di vuota materia e fredde luci,\\
    e non avevo forza\\
    e gioia per Te.\\
    \leavevmode
    Una nuova eterna via,\\
    vedo in te.\\
    Lascio tutto,\\
    e ti seguo,\\
...
\begin{haiku}
    ...
    la mia anima,\\
    unita a Te\\
    con candida veste\footnote{la carita'},\\
    e' magnifica,\\
    e potente e' lo Spirito\\
    che l'alimenta.\\
    Io sono, \\
    ai Tuoi occhi,\\
...
\centerpoemon{Mi chiedi cosa vuol dir amare?}
\begin{haiku}
        Figlio mio,\\
        vivo,\\
        quando sto' bene.\\
...
\centerpoemon{un incantevole fiore}
\begin{haiku}
Dal lunedi' \\
al venerdi',\\
in miniera\\
...
\centerpoemon{sono cio' che sono per lui,}
\begin{haiku}
    Che io dica: \\
...
\begin{vcentered}
    ...
    Chi vive secondo la carita', invece, contento della sua vita, dice: ``Gesu' e' il Signore, ed e' risorto in me, per quanto con i miei peccati deturpi la sua immagine. E' il Signore, perche' lui ha fatto degli ultimi i primi, e li ha posti accanto a lui nel regno dei cieli. E' il Signore perche' senza macchia, ha guarito ed insegnato a molti, e ha accettato la morte della sua persona per donare il suo Spirito a tutti coloro che vivono secondo carita'.
    Con tutti coloro che vivono secondo la carita', santi, in coro, all'unisono, sono un Essere solo, uno con Gesu', risorto in terra, re dell'Universo.''
\end{vcentered}


\centerpoemon{nell'unirmi a Te,}
\begin{haiku}
Preghiera e'\\
bruciare\\
la mia anima\\
...
\centerpoemon{Si, esiste Colui che e' vita.}
\begin{haiku}
    L'unico,\\
    semplice,\\
    fondamentale algoritmo:\\
    \leavevmode\\
    \hspace{5mm} abbi fede!\\
    \leavevmode\\
    Si, esiste la vita.\\
    Si, esiste Colui che e' vita.\\
    \leavevmode\\
    Vivi,\\
    nel bene e solo nel bene,\\
