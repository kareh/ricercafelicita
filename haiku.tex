...
\leavevmode\\
\leavevmode\\
Il Padre e' il centro dell'esistenza. Un Io e' alla costante ricerca del suo centro. E' quel raggiungimento esistenziale, istantaneo e immutabile, dove l'Io dice: ``ecco, sono''. 
...
Forse rimane irraggiungibile nella vita terrena ai piu', ma c'e' ed e' cio' a cui anela l'anima. Dio Padre e' tale centro. Ogni sforzo, per quanto piccolo, nell'avvicinarsi a Lui, giovera' all'anima.
\leavevmode\\
    Un modo per visualizzare tutto questo e' immaginare l'anima come il guscio di una sfera. Il centro della sfera e' il Padre. L'Io umano, non santo, e' un punto interno della sfera, che approssima il centro, ma non e' il centro. L'Io umano santo, e' il centro, e' tutto Spirito Santo, e coincide con il Padre. L'Io illumina, riscalda, alimenta l'anima, e tanto piu' coincide col centro, tanto meglio riesce a farlo.\\
Un'altra immagine e' la seguente.
