...
\centerpoemon{fisica, matematica, filosofia,}
\begin{haiku}
    Le parole:\\
...
\centerpoemon{Proiezione reale delle altezze dell'anima}
\begin{haiku}
Padre buono,\\
saggio e forte,\\
...
Proiezione di chi si e' unito a Lui,\\
e ancora ama,\\
...
sui suoi bisogni e\\
desideri necessari.\\
Potro' mai essere come te?\\
Anche solo degno di slegarti\\
i lacci dei sandali?\\
\leavevmode\\
Reale, ancora oggi,\\
quando in due o tre,\\
...
\centerpoemon{\quad avrai verso Me, ben camminato,}
\begin{haiku}
    Cosi' mi parli: \enquote{\\
    \quad quando, dopo a lungo,\\
    \quad avrai verso Me ben camminato,\\
    \quad e ti volterai indietro,\\
    \quad non dirai ``sono cambiato'',\\
    \quad piuttosto, ``Io sono più Io''.\\
    \quad \leavevmode\\
    \quad E raggiunta l'eternita'\\
    \quad per tuo impegno,\\
    \quad e giunta l'eternita' a te\\
    \quad per mia grazia,\\
    \quad dirai ``Io sono'',\\
    \quad sarai tutto,\\
    \quad senza riserve, \\
    \quad all'amore orientato,\\
    \quad sarai uno con Me.\\
    \quad Non sarai piu' tuo,\\
    \quad ne di nessuno,\\
    \quad ma di tutti d'amore\\
    \quad figlio fedele.\\
    \quad \leavevmode\\
    \quad In Spirito e verita'\\
    \quad sarai Me,\\
    \quad ed Io te.\\
    \quad Cio' che vorro',\\
    \quad sara' cio' che vorrai,\\
    \quad cio' che guarderai,\\
    \quad cio' che guardero'.\\
    \quad \leavevmode\\
    \quad Così il regno\\
    \quad dei cieli.}\\
\end{haiku}
