...
Caro figlio, cara figlia,\\
    le forze tue e dell'uomo, sono grandi e ammirabili, ma non bastano per stare bene in questo mondo. \\
    Solo la rugiada della mia carita', \\
    che e' in abbondanza nel regno dei cieli,\\
    ma che poco trapela dalla dura roccia\\
    dei cuori altrui, \\
    dei tuoi avi e genitori, \\
    e da quella di te stessa,\\
    brilla tra le tenebre, \\
    ha sapore, \\
    e nutre.\\
Solo visitare le oscure fredde tenebre \\
    delle tue profondita', \\
    non per dominarle o distruggerle, \\
    ma per infiammarle del mio amore, \\
...
Non seguire l'esempio del mondo,\\
    ...
    ma il suo cuore e' duro come la pietra,\\
    e la sua parola stride come il ferro sul ferro.\\
Guardami, \\
    ...
    Riempiti del mio amore,\\
    che non giudica,\\
    ne scusa superficialmente,\\
    e rimane per mille generazioni.\\}
\end{vcentered}
