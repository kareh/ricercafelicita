...
\begin{vcentered}
    ...
    \begin{align*}
        ...
        &\lim_{\textrm{morte} \to 0} \textrm{EssereUmano} = \textrm{Dio}\\
    \end{align*}

\centerpoemon{Oh infinita realizzazione,}
    \begin{poem}
        Limite all'infinito,\\
        dell'Io mio e altrui,\\
        che ama e soltanto ama.\\
        Limite per la morte,\\
        del se e dell'altro,\\
        che tende a zero.\\
        Punto all'infinito,\\
        ...
        in noi,\\
        nei nostri aspetti\\
        che sono in parte Te,\\
        e ricordano Te.\\
    \end{poem}

\end{vcentered}

\centerpoemon{cosi' come noi ricompensiamo gli altri.}
\begin{haiku}
