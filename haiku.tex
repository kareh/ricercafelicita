...
\centerpoemon{risolviamo i nostri conflitti interiori,}
\begin{haiku}
Gesu' e' un corpo \\
dell'Universo,\\
ma non e' l'Universo.\\
...
e' Dio,\\
uno con il Padre.\\
Lui si e' donato a noi,\\
il Suo spirito ha risuonato\\
nei suoi e in chi ha creduto,\\
e in noi, ogni volta che
risolviamo i nostri conflitti interiori,\\
nella pace e solo con la pace,\\
risplende maggiormente il suo volto\\
nel nostro,\\
ci facciamo uni con Lui,\\
e con il Padre,\\
e in terra vive, e noi\\
figli del Padre nostro,\\
gioiamo.\\
\end{haiku}
