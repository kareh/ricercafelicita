...
dimentica di stare con le tue forze bene \\
    in questo mondo.\\
Solo la rugiada della Sua carita', \\
    che trapela dalla dura roccia dei cuori altrui, \\
    dei nostri avi e genitori, \\
    e da quella durissima di noi stessi,\\
    risplende tra le tenebre, \\
    ha sapore, \\
    e nutre. \\
Solo visitare le oscure fredde tenebre \\
    delle nostre profondita', \\
    non per dominarle o distruggerle, \\
    ma per infiammarle del Suo amore, \\
    dona vera ricchezza e forza.\\
Non seguire l'esempio del mondo, che per paura di vedere la propria miseria, debolezza e infermita', cerca altre vane vie. Si fa onnipotente nel dominare la materia morta, si fa libero nel perdersi, si fa sapiente di scienze senza cuore, si nutre di piaceri che ad ogni pasto lo lasciano piu' affamato di prima, si fa bello di fascini illusori e di successi fugaci, si proclama giusto ma il suo cuore e' duro come la pietra.
\end{vcentered}
