...
\centerpoemon{Quindi, se l'Io si ostina a volere di piu' di quello che puo' prendere dalla Natura,}
\begin{haiku}
    ...
    non la morte.\\
    \leavevmode\\
    Dio non ammette uno spreco di neanche un infinitesimo di vita.\\
    E se sulla terra il corpo si logora nel tempo,\\
    e l'animo e' messo a continue prove,\\
    e' perche' il nostro corpo, ama la Natura, con ogni suo atomo.\\
    Quindi, se l'Io si ostina a volere di piu' di quello che puo' prendere dalla Natura,\\
    se testardamente non sacrifica niente di se' per vincere la sorte naturale,\\
    viviamo fatica,\\
    e allo stesso modo, il nostro animo, limitato fisicamente nei suoi desideri,\\
