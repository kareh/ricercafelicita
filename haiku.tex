...
\centerpoemon{e' in armonia con l'Universo}
\begin{haiku}
Io non sono\\
Dio padre.\\
Sono un corpo \\
...
\centerpoemon{il pregiudizio, la superbia, la chiusura}
\begin{haiku}
    Tu,\\
che trasformi l'h2o\\
in acqua,\\
la luce\\
in forme e colori,\\
il pregiudizio, la superbia, la chiusura,\\
in umiltà, tolleranza, e fraternità,\\
Tu,\\
    sei il Re dell'Universo.\\
\end{haiku}
